...
// They DO have retail addresses. DATA belongs on their canonical .cpp definition; this header
// only carries declarations for synthetic storage that is genuinely shared across modules.
// Kept OUT of _globals.h, which is reserved for CodeView-backed data.
#include <_types.h>
#include <windows.h>
