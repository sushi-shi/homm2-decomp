...
public:
    ...
    H2EnumStorage<FontDrawMode, i16> m_normalColor;
    H2EnumStorage<FontDrawMode, i16> m_selColor;
    H2EnumStorage<FontDrawMode, i16> m_unusedColor;
    H2EnumStorage<FontAlignment, i16> m_alignment;
    i16 m_itemCount;
    i16 m_selectedIndex;
    char** m_items;
    i16 m_topIndex;
