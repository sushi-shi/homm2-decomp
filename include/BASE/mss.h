...
extern "C" void _AIL_set_sample_volume_8(struct _SAMPLE *, int);
extern "C" void _AIL_start_sample_4(struct _SAMPLE *);
extern "C" void _AIL_init_sample_4(struct _SAMPLE *);
extern "C" void _AIL_set_sample_type_12(struct _SAMPLE *, int, int);
extern "C" void _AIL_set_sample_playback_rate_8(struct _SAMPLE *, int);
extern "C" void _AIL_set_sample_loop_count_8(struct _SAMPLE *, int);
extern "C" void _AIL_set_sample_address_12(struct _SAMPLE *, int, int);
