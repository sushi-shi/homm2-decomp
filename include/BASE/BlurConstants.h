...
HOMM2_ENUM_VALUES_BEGIN(BlurKernelConstant)
...
HOMM2_ENUM_VALUES_END(BlurKernelConstant)

HOMM2_ENUM_BEGIN(BlurPaletteChannel)
    BLUR_RED_CHANNEL = 0,
    BLUR_GREEN_CHANNEL = 1,
    BLUR_BLUE_CHANNEL = 2
HOMM2_ENUM_END(BlurPaletteChannel)

// The game palette stores 256 RGB triplets with six-bit component values.
HOMM2_ENUM_VALUES_BEGIN(BlurPaletteConstant)
...
HOMM2_ENUM_VALUES_END(BlurPaletteConstant)

// RGBLOOKP.BIN is addressed as 1024 rows of 32 quantized blue entries.
HOMM2_ENUM_VALUES_BEGIN(BlurLookupConstant)
...
HOMM2_ENUM_VALUES_END(BlurLookupConstant)

HOMM2_ENUM_VALUES_BEGIN(BlurTransitionConstant)
    BLUR_FIZZLE_DELAY = 150
HOMM2_ENUM_VALUES_END(BlurTransitionConstant)
