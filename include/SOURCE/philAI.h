...
public:
    ...
    void BuildBuilding(class town* townPointer, H2_ENUM_PARAM(BuildingSlotType, i32) building);
    ...
    i32 CombatMonsterEvent(
        class hero* heroPointer, H2_ENUM_PARAM(CreatureType, i32) monType, i32* pCount, class mapCell* cell
    );
