...
public:
    ...
    void ProbableOutcomeOfBattle(class armyGroup *, class hero *, class armyGroup *, class hero *, class armyGroup *, i32, i32, i32, float &, i32 &, i32 &, i32 &, i32 &, i32 &);
    ...
    void LikelihoodOfEnemyAttacking(class town *, class hero *, float &, float &, i32 &, i32 &, i32 &, float &);
    ...
    i32 QuickCombat(class armyGroup *, class hero *, class armyGroup *, class hero *, i32, i32, float &, float &);
    ...
    void ChooseEvaluateBattle(class armyGroup *, class hero *, class armyGroup *, class hero *, i32, i32, i32, i32 &, i32 &);
