...
public:
    ...
    i32 CreaturesToBuy(CreatureType a, i32 b);
    ...
    void BuildBuilding(class town* t, BuildingSlotType building);
    ...
    i32 CombatMonsterEvent(
        class hero* h, CreatureType monType, i32* pCount, class mapCell* cell
    );
    ...
    i32 ComputeValueOfFreeSS(class hero* h, HeroSecondarySkill skill);
