...
HOMM2_ENUM_VALUES_BEGIN(FileRequesterControlId)
...
HOMM2_ENUM_VALUES_END(FileRequesterControlId)
...
HOMM2_ENUM_BEGIN(FileRequesterKey)
    FILE_REQUESTER_KEY_CYCLE_FILTER = 0x40
HOMM2_ENUM_END(FileRequesterKey)

HOMM2_ENUM_BEGIN(FileRequesterHelpIndex)
...
HOMM2_ENUM_END(FileRequesterHelpIndex)
