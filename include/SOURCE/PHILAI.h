...
typedef enum AIGenericSiteConstant {
    ...
    AI_GENERIC_SITE_UPGRADE_FROM = 7,
    AI_GENERIC_SITE_UPGRADE_TO = 8,
    AI_GENERIC_SITE_WEEK_END = 8,
    AI_GENERIC_SITE_FAERIE_RING_FLAG = 0x00100000,
    AI_GENERIC_SITE_GRAVEYARD_FLAG = 0x00200000,
    AI_GENERIC_SITE_SHIPWRECK_FLAG = 0x00400000,
    AI_GENERIC_SITE_CREATURE_UPGRADE_FLAG = 0x00800000
