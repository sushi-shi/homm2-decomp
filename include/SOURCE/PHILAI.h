...
HOMM2_ENUM_END(AIArtifactEventMode)

HOMM2_ENUM_BEGIN(AIArtifactEventValue)
...
HOMM2_ENUM_END(AIArtifactEventValue)

HOMM2_ENUM_VALUES_BEGIN(AIFightEventConstant)
...
HOMM2_ENUM_VALUES_END(AIFightEventConstant)

HOMM2_ENUM_VALUES_BEGIN(AIShipwreckSurvivorConstant)
    AI_SHIPWRECK_SURVIVOR_ARTIFACT_METADATA_OFFSET = 2
HOMM2_ENUM_VALUES_END(AIShipwreckSurvivorConstant)

HOMM2_ENUM_BEGIN(AIPurchaseType)
    AI_PURCHASE_BUILDING = 0,
    AI_PURCHASE_HERO = 1,
    AI_PURCHASE_CREATURE = 2
HOMM2_ENUM_END(AIPurchaseType)

HOMM2_ENUM_VALUES_BEGIN(AIPurchaseConstant)
...
HOMM2_ENUM_VALUES_END(AIPurchaseConstant)

HOMM2_ENUM_VALUES_BEGIN(AIBattleConstant)
...
HOMM2_ENUM_VALUES_END(AIBattleConstant)

HOMM2_ENUM_VALUES_BEGIN(AIHeroInteractionConstant)
    AI_HERO_INTERACTION_HERO_COUNT = 2,
    AI_HERO_INTERACTION_PRIMARY_STAT_COUNT = 4,
    AI_HERO_INTERACTION_PRIMARY_STAT_VALUE = 800
HOMM2_ENUM_VALUES_END(AIHeroInteractionConstant)

HOMM2_ENUM_VALUES_BEGIN(AITownEventConstant)
    AI_TOWN_EVENT_NO_HERO = -1,
    AI_TOWN_EVENT_ATTACKER_WON = 0,
    AI_TOWN_EVENT_USE_GARRISON = 1
HOMM2_ENUM_VALUES_END(AITownEventConstant)

HOMM2_ENUM_VALUES_BEGIN(AISecondarySkillConstant)
...
HOMM2_ENUM_VALUES_END(AISecondarySkillConstant)
...
HOMM2_ENUM_VALUES_BEGIN(AIGenericSiteConstant)
...
HOMM2_ENUM_VALUES_END(AIGenericSiteConstant)
...
HOMM2_ENUM_VALUES_BEGIN(AISideConstant)
    AI_SIDE_NO_PLAYER = -1,
...
HOMM2_ENUM_VALUES_END(AISideConstant)

HOMM2_ENUM_VALUES_BEGIN(AICreaturePurchaseConstant)
...
HOMM2_ENUM_VALUES_END(AICreaturePurchaseConstant)

HOMM2_ENUM_VALUES_BEGIN(AIPositionValueConstant)
...
HOMM2_ENUM_VALUES_END(AIPositionValueConstant)

HOMM2_ENUM_VALUES_BEGIN(AIQuickCombatConstant)
...
HOMM2_ENUM_VALUES_END(AIQuickCombatConstant)
...
#define AI_TOWN_PRIMARY_SKILL_SHARE_BASE 0.54
...
#define AI_HERO_PURCHASE_CLASS_DIVISOR 2.0
...
HOMM2_ENUM_VALUES_BEGIN(AIEventEvaluationConstant)
...
HOMM2_ENUM_VALUES_END(AIEventEvaluationConstant)

HOMM2_ENUM_VALUES_BEGIN(AITownEvaluationConstant)
    AI_TOWN_EARLY_DIFFICULTY_LIMIT = 3,
    AI_TOWN_EARLY_TURN_BASE = 40,
    AI_TOWN_EARLY_TURN_DIFFICULTY_STEP = 8
HOMM2_ENUM_VALUES_END(AITownEvaluationConstant)
