...
extern const char* cCampaignName[(CAMPAIGN_SIDE_COUNT)][CAMPAIGN_MAP_COUNT];
extern const char* cCampaignDescription[(CAMPAIGN_SIDE_COUNT)][CAMPAIGN_MAP_COUNT];
...
typedef enum NormalDialogResourceType {
    ...
    NORMAL_DIALOG_RESOURCE_WOOD    = (RES_WOOD),
    NORMAL_DIALOG_RESOURCE_FIRST   = NORMAL_DIALOG_RESOURCE_WOOD,
    NORMAL_DIALOG_RESOURCE_MERCURY = (RES_MERCURY),
    NORMAL_DIALOG_RESOURCE_ORE     = (RES_ORE),
    NORMAL_DIALOG_RESOURCE_SULFUR  = (RES_SULFUR),
    NORMAL_DIALOG_RESOURCE_CRYSTAL = (RES_CRYSTAL),
    NORMAL_DIALOG_RESOURCE_GEMS    = (RES_GEMS),
    NORMAL_DIALOG_RESOURCE_GOLD    = (RES_GOLD),
...
typedef i32 CheckEndGameForcedResult;
...
extern i32 gDwellingCosts[][DWELLING_TYPE_COUNT][(RES_COUNT)];
extern const char* gDwellingNames[][DWELLING_TYPE_COUNT];
extern i8 gDwellingType[][DWELLING_TYPE_COUNT];
...
extern i32 gMageBuildingCosts[][(RES_COUNT)];
...
extern i32 gNeutralBuildingCosts[][(RES_COUNT)];
...
extern i32 gSpecialBuildingCosts[][(RES_COUNT)];
