...
typedef enum CampaignChoiceValue {
    ...
    CAMPAIGN_RESOURCE_MERCURY = 1,
    CAMPAIGN_RESOURCE_CRYSTAL = 4,
    CAMPAIGN_RESOURCE_GEMS = 5,
    CAMPAIGN_RESOURCE_GOLD = 6,
    CAMPAIGN_ARTIFACT_MAGE_RING = 10,
    CAMPAIGN_ARTIFACT_FIZBIN_MISFORTUNE = 16,
    CAMPAIGN_ARTIFACT_THUNDER_MACE = 17,
    CAMPAIGN_ARTIFACT_ARMORED_GAUNTLETS = 18,
    CAMPAIGN_ARTIFACT_DEFENDER_HELM = 19,
    CAMPAIGN_ARTIFACT_DRAGON_SWORD = 23,
    CAMPAIGN_ARTIFACT_POWER_AXE = 24,
    CAMPAIGN_ARTIFACT_DIVINE_BREASTPLATE = 25,
    CAMPAIGN_ARTIFACT_MINOR_SCROLL = 26,
    CAMPAIGN_ARTIFACT_TAX_LIEN = 69,
    CAMPAIGN_ARTIFACT_HIDEOUS_MASK = 70,
    CAMPAIGN_ARTIFACT_WHITE_PEARL = 79,
    CAMPAIGN_ARTIFACT_BLACK_PEARL = 80,
    ...
    CAMPAIGN_ALIGNMENT_SORCERESS = 2,
    CAMPAIGN_ALIGNMENT_WARLOCK = 3,
    CAMPAIGN_ALIGNMENT_WIZARD = 4,
    CAMPAIGN_ALIGNMENT_NECROMANCER = 5
} CampaignChoiceValue;
...
struct SPlayerExit {
    ...
    signed char updateNetworkControl;
    signed char timedOut;
    signed char eliminated;
    signed char hostReported;
    signed char continueGame;
};
SIZE(SPlayerExit, 7);
...
typedef enum EventWindowConstant {
    EVENT_WINDOW_MESSAGE = 0x200,
    EVENT_WINDOW_RESOURCE_FLAG = 0x200,
    EVENT_WINDOW_HOVER_COMMAND = 0xc,
    EVENT_WINDOW_CLICK_COMMAND = 0xd,
    EVENT_WINDOW_HELP_COMMAND = 0xe,
    ...
    EVENT_WINDOW_SPELL_SCROLL = 0x56,
...
typedef enum KbBuildingType {
    ...
    KB_BUILDING_DOCK = 3,
    KB_BUILDING_UPGRADE_CASTLE = 5,
    KB_BUILDING_CASTLE = 6,
    KB_BUILDING_WELL_EXTRA = 11,
    KB_BUILDING_SPECIAL = 13,
    KB_BUILDING_DISABLED_FIRST = 14,
    KB_BUILDING_NEUTRAL_LAST = 15,
    KB_BUILDING_DISABLED_SECOND = 16,
    KB_BUILDING_DISABLED_THIRD = 17,
    KB_BUILDING_DISABLED_FOURTH = 18,
    KB_BUILDING_DWELLING_FIRST = 19,
    KB_BUILDING_DWELLING_SECOND = 20,
    KB_BUILDING_DWELLING_THIRD = 21,
    KB_BUILDING_DWELLING_FOURTH = 22,
    KB_BUILDING_DWELLING_FIFTH = 23,
    KB_BUILDING_DWELLING_SIXTH = 24,
    KB_BUILDING_UPGRADE_FIRST = 25,
    KB_BUILDING_NECROMANCER_MAGE_PREREQUISITE = 28,
    KB_BUILDING_UPGRADE_LAST = 29,
    KB_BUILDING_DWELLING_LAST = 30,
    KB_BUILDING_DISABLED_LAST = 31
} KbBuildingType;
...
typedef enum KbSourceLine {
    KB_SOURCE_LINE_CLEAR_MAP_EXTRA_BASE = 0x0cbe,
    KB_SOURCE_LINE_CLEAR_MAP_EXTRA_ITEM_FREE_OFFSET = 0x06,
    KB_SOURCE_LINE_CLEAR_MAP_EXTRA_POINTER_FREE_OFFSET = 0x09,
    KB_SOURCE_LINE_CLEAR_MAP_EXTRA_SIZE_FREE_OFFSET = 0x0d,
    KB_SOURCE_LINE_SHUTDOWN_BASE = 0x0ef4,
    KB_SOURCE_LINE_SHUTDOWN_MAP_FREE_OFFSET = 0x47,
    KB_SOURCE_LINE_SMACK_FADE_BASE = 0x0f61,
    KB_SOURCE_LINE_SMACK_FADE_PALETTE_ALLOC_OFFSET = 0x0d,
    KB_SOURCE_LINE_SMACK_FADE_MAP_ALLOC_OFFSET = 0x0e,
    KB_SOURCE_LINE_SMACK_FADE_PALETTE_FREE_OFFSET = 0x31,
    KB_SOURCE_LINE_SMACK_FADE_MAP_FREE_OFFSET = 0x32,
    KB_SOURCE_LINE_CONGRATS_BASE = 0x0f97,
    KB_SOURCE_LINE_CONGRATS_ALLOC_OFFSET = 0x09,
    KB_SOURCE_LINE_CONGRATS_FREE_OFFSET = 0x4e,
    KB_SOURCE_LINE_NORMAL_DIALOG_BASE = 0x14a5,
    KB_SOURCE_LINE_NORMAL_DIALOG_FIRST_TEXT_ALLOC_OFFSET = 0xbb,
    KB_SOURCE_LINE_NORMAL_DIALOG_SECONDARY_TEXT_ALLOC_OFFSET = 0x1af,
    KB_SOURCE_LINE_NORMAL_DIALOG_PRIMARY_BONUS_ALLOC_OFFSET = 0x1c9,
    KB_SOURCE_LINE_NORMAL_DIALOG_OR_TEXT_ALLOC_OFFSET = 0x1ed
} KbSourceLine;
...
struct OldMainNetSetup {
    signed char gamePosToNetPos[OLD_MAIN_PLAYER_COUNT];
