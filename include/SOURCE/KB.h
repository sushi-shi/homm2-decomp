...
typedef enum KbBuildingConstant {
    ...
    KB_NEUTRAL_BASE_RESOURCE_VALUE_COUNT = KB_BUILDING_DWELLING_FIRST + 1,
...
typedef enum NormalDialogConstant {
    ...
    NORMAL_DIALOG_FIRST_TEXT_LINE = 5472,
    NORMAL_DIALOG_SECONDARY_TEXT_LINE = 5716,
    NORMAL_DIALOG_PRIMARY_BONUS_LINE = 5742,
    NORMAL_DIALOG_OR_TEXT_LINE = 5778
