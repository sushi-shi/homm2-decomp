...
HOMM2_ENUM_VALUES_BEGIN(ExpansionCampaignMap)
...
HOMM2_ENUM_VALUES_END(ExpansionCampaignMap)

HOMM2_ENUM_VALUES_BEGIN(ExpansionCampaignSmacker)
...
HOMM2_ENUM_VALUES_END(ExpansionCampaignSmacker)
