...
typedef enum AdventureSourceLineConstant {
    ADVMGR_BORDER_FREE_LINE_BASE = 0x0124,
...
typedef enum AdventureSearchConstant {
    ...
    ADVMGR_CRYSTAL_BALL_ARTIFACT = 91,
...
typedef enum AdventureSpell {
    ADVENTURE_SPELL_VIEW_MINES = 48,
    ADVENTURE_SPELL_VIEW_RESOURCES = 49,
    ADVENTURE_SPELL_VIEW_ARTIFACTS = 50,
    ADVENTURE_SPELL_VIEW_TOWNS = 51,
    ADVENTURE_SPELL_VIEW_HEROES = 52,
    ADVENTURE_SPELL_VIEW_ALL = 53,
    ADVENTURE_SPELL_IDENTIFY_HERO = 54,
    ADVENTURE_SPELL_SUMMON_BOAT = 55,
    ADVENTURE_SPELL_DIMENSION_DOOR = 56,
    ADVENTURE_SPELL_TOWN_GATE = 57,
    ADVENTURE_SPELL_TOWN_PORTAL = 58,
    ADVENTURE_SPELL_VISIONS = 59,
    ADVENTURE_SPELL_HAUNT = 60,
    ADVENTURE_SPELL_SET_EARTH_GUARDIAN = 61,
    ADVENTURE_SPELL_SET_AIR_GUARDIAN = 62,
    ADVENTURE_SPELL_SET_FIRE_GUARDIAN = 63,
    ADVENTURE_SPELL_SET_WATER_GUARDIAN = 64
} AdventureSpell;
...
typedef enum AdventureSpellConstant {
    ...
    ADVMGR_MINE_GUARDIAN_GHOST = 59,
    ADVMGR_MINE_GUARDIAN_EARTH_ELEMENTAL = 62,
    ADVMGR_MINE_GUARDIAN_AIR_ELEMENTAL = 63,
    ADVMGR_MINE_GUARDIAN_FIRE_ELEMENTAL = 64,
    ADVMGR_MINE_GUARDIAN_WATER_ELEMENTAL = 65
