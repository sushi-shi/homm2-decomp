...
HOMM2_ENUM_VALUES_BEGIN(TownManagerInputCode)
...
HOMM2_ENUM_VALUES_END(TownManagerInputCode)

HOMM2_ENUM_VALUES_BEGIN(TownObjectId)
    TOWN_OBJECT_NONE = -1,
...
HOMM2_ENUM_VALUES_END(TownObjectId)
...
HOMM2_ENUM_VALUES_BEGIN(TownManagerArmyCommand)
...
HOMM2_ENUM_VALUES_END(TownManagerArmyCommand)
