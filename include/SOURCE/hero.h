...
typedef enum HeroArtifact {
    HERO_ARTIFACT_NONE = -1,
    HERO_ARTIFACT_TRANSFERABLE_FIRST = 8,
    HERO_ARTIFACT_MEDAL_OF_VALOR = 0x0c,
    HERO_ARTIFACT_MEDAL_OF_COURAGE = 0x0d,
    HERO_ARTIFACT_MEDAL_OF_HONOR = 0x0e,
    HERO_ARTIFACT_MEDAL_OF_DISTINCTION = 0x0f,
    HERO_ARTIFACT_FIZBIN_OF_MISFORTUNE = 0x10,
