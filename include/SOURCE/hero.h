...
typedef i32 HeroSecondarySkill;
...
typedef enum HeroConstant {
    ...
    HERO_BASE_LEARNABLE_SPELL_LEVEL           = (SPELL_LEVEL_SECOND),
...
#define HERO_SCOUTING_VISIBILITY_RADIUS(h)                                                         \
    (giVisRange[((h).m_secondarySkills[(HERO_SKILL_SCOUTING)])]                              \
