...
typedef u8 SpellInfoAttribute;

typedef enum SpellInfoConstant {
    SPELL_INFO_SOUND_NAME_SIZE = 9,
    SPELL_INFO_RACE_COUNT      = (FACTION_COUNT)
} SpellInfoConstant;
