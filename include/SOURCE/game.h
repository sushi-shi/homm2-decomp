...
public:
    ...
    hero *GetHero(i32 id) { return &m_heroRecs[id]; }
    town *GetTown(i32 id) { return &m_castleRecs[id]; }
    ...
    i8 GetPlayerColor(i32 player) { return m_players[player].m_color; }
    ...
    void ViewArmy(i32, i32, i32, i32, class town *, i32, i32, i32, class hero *, class army *, class armyGroup *, i32);
...
extern i32 gbNewGameDialogOver;
...
extern i32 gbNewGameShadowHidden;
