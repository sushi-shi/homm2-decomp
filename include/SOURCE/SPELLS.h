...
using enum BoltColorMode;
ENABLE_ENUM_FLAGS(BoltColorMode)

typedef enum SpellGameplayConstant {
...
typedef enum SpellAreaConstant {
    ...
    SPELL_FIREBLAST_CORNER_SECOND     = 16,
    SPELL_FIREBLAST_CORNER_THIRD      = 17,
    SPELL_FIREBLAST_CORNER_FOURTH     = 18,
    SPELL_FIREBLAST_HEX_ROW_STRIDE    = 26,
    SPELL_METEOR_AFFECTED_HEX_COUNT   = 7,
} SpellAreaConstant;

typedef enum BoltDrawingConstant {
...
typedef enum RippleDrawingConstant {
    RIPPLE_MARGIN                     = 10,
...
typedef enum SpellStatConstant {
