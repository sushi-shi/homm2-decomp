...
H2_ENUM_BEGIN(SpellGameplayConstant)
...
H2_ENUM_BEGIN(BoltDrawingConstant)
...
H2_ENUM_END(BoltDrawingConstant)

H2_ENUM_BEGIN(RippleDrawingConstant)
    RIPPLE_MARGIN                     = 10,
...
H2_ENUM_END(RippleDrawingConstant)
