...
typedef enum CombatSpellArtifact {
    ...
    SPELL_ARTIFACT_LIGHTNING_HELM = 0x2f,
    SPELL_ARTIFACT_EVERCOLD_ICICLE = 0x30,
    SPELL_ARTIFACT_EVERHOT_LAVA_ROCK = 0x31,
    SPELL_ARTIFACT_LIGHTNING_ROD = 0x32,
    ...
    SPELL_ARTIFACT_BROACH_SHIELDING = 0x59,
    SPELL_ARTIFACT_HEART_FIRE = 0x5c,
    SPELL_ARTIFACT_HEART_ICE = 0x5d,
