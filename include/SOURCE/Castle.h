...
HOMM2_ENUM_VALUES_BEGIN(CastleControl)
...
HOMM2_ENUM_VALUES_END(CastleControl)

HOMM2_ENUM_VALUES_BEGIN(CastleWidgetCommand)
    CASTLE_WIDGET_TEXT = 3,
    CASTLE_WIDGET_FRAME = 4,
    CASTLE_WIDGET_ENABLE = 5,
    CASTLE_WIDGET_DISABLE = 6,
    CASTLE_WIDGET_ICON_FILE = 9
HOMM2_ENUM_VALUES_END(CastleWidgetCommand)
