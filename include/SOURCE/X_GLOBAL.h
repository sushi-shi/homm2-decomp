...
extern const char* gArtifactNames[KB_ARTIFACT_TABLE_CAPACITY];
extern const char* gArtifactDesc[KB_ARTIFACT_TABLE_CAPACITY];
extern const char* gArtifactEvent[KB_ARTIFACT_LEVEL_COUNT];
