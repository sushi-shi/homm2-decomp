...
extern H2_ENUM_STORAGE(CombatCastleHex, u8) iWallToHexCell[KB_CASTLE_WALL_SEGMENT_COUNT];
extern H2_ENUM_STORAGE(CombatCastleHex, u8) iTowerToHexCell[KB_CASTLE_TOWER_COUNT];
...
extern H2_CONST char* gArtifactNames[IDX(ARTIFACT_COUNT)];
extern H2_CONST char* gArtifactDesc[IDX(ARTIFACT_COUNT)];
extern H2_CONST char* gArtifactEvent[IDX(ARTIFACT_COUNT)];
extern H2_CONST char* gStatNames[HERO_PRIMARY_STAT_COUNT];
...
extern H2_CONST char* gCSPanelHelp[KB_COMBAT_SPELL_PANEL_HELP_COUNT];
extern H2_CONST char* gAPanelHelp[KB_ADVENTURE_PANEL_HELP_COUNT];
extern H2_CONST char* gInitMenuHelp[KB_INIT_MENU_HELP_COUNT];
extern H2_CONST char* gAdvMenuHelp[KB_ADVENTURE_MENU_HELP_COUNT];
extern H2_CONST char* gLuckText[KB_LUCK_TEXT_COUNT];
extern H2_CONST char* gMoraleText[KB_MORALE_TEXT_COUNT];
extern H2_CONST char* onOffText[KB_ON_OFF_TEXT_COUNT];
extern H2_CONST char* walkSpeedText[KB_WALK_SPEED_TEXT_COUNT];
extern H2_CONST char* gColors[IDX(FACTION_COUNT)];
extern H2_CONST char* gMonthNames[KB_MONTH_NAME_COUNT];
extern H2_CONST char* gWeekNames[KB_WEEK_NAME_COUNT];
extern H2_CONST char* cHeroScreen[KB_HERO_SCREEN_TEXT_COUNT];
extern H2_CONST char* cCastleInfo[KB_CASTLE_INFO_TEXT_COUNT];
extern H2_CONST char* cLuckInfo[KB_LUCK_INFO_TEXT_COUNT];
extern H2_CONST char* IQnames[KB_IQ_NAME_COUNT];
extern H2_CONST char* cSpellHelp[KB_SPELL_HELP_TEXT_COUNT];
extern H2_CONST char* speedText[KB_SPEED_TEXT_COUNT];
extern H2_CONST char* cArmyDetail[KB_ARMY_DETAIL_TEXT_COUNT];
extern H2_CONST char* cWellDetail[KB_WELL_DETAIL_TEXT_COUNT];
extern H2_CONST char* cKingdomOverview[KB_KINGDOM_OVERVIEW_TEXT_COUNT];
extern H2_CONST char* cNewTurn[KB_NEW_TURN_TEXT_COUNT];
extern H2_CONST char* cViewGeneralLabels[KB_VIEW_GENERAL_LABEL_COUNT];
extern H2_CONST char* cViewGeneralHelp[KB_VIEW_GENERAL_HELP_COUNT];
extern H2_CONST char* cViewGeneralLongHelp[KB_VIEW_GENERAL_LONG_HELP_COUNT];
extern H2_CONST char* cCombatMessage[KB_COMBAT_MESSAGE_COUNT];
extern H2_CONST char* cHeroLevel[KB_HERO_LEVEL_TEXT_COUNT];
...
extern H2_CONST char* gSetupDCBaudHelp[KB_SETUP_DC_BAUD_HELP_COUNT];
extern H2_CONST char* gSetupDCComPortHelp[KB_SETUP_DC_COM_PORT_HELP_COUNT];
extern H2_CONST char* gSetupHotSeatGameHelp[KB_SETUP_HOT_SEAT_HELP_COUNT];
extern H2_CONST char* gSetupModemGameHelp[KB_SETUP_MODEM_HELP_COUNT];
extern H2_CONST char* gSetupDCGameHelp[KB_SETUP_DIRECT_CONNECT_HELP_COUNT];
extern H2_CONST char* gSetupMultiPlayerGameHelp[KB_SETUP_MULTIPLAYER_HELP_COUNT];
extern H2_CONST char* gSetupNetworkGameHelp[KB_SETUP_NETWORK_HELP_COUNT];
extern H2_CONST char* gSetupNetworkGame2Help[KB_SETUP_NETWORK_SECOND_HELP_COUNT];
extern H2_CONST char* gSetupGameHelp[KB_SETUP_GAME_HELP_COUNT];
...
extern H2_CONST char* cWinComError[KB_WIN_COM_ERROR_TEXT_COUNT];
extern H2_CONST char* cMiniViewText[KB_MINI_VIEW_TEXT_COUNT];
extern H2_CONST char* gFileRequestHelp[KB_FILE_REQUEST_HELP_COUNT];
extern H2_CONST char* cPersonality[KB_PERSONALITY_TEXT_COUNT];
extern H2_CONST char* gArmySizeNames[KB_ARMY_SIZE_NAME_COUNT][KB_ARMY_SIZE_NAME_VARIANT_COUNT];
extern H2_CONST char* cRandomTavernText[KB_RANDOM_TAVERN_TEXT_COUNT];
extern H2_CONST char* cRandomSignText[KB_RANDOM_SIGN_TEXT_COUNT];
extern H2_CONST char* cCampaignAwards[KB_CAMPAIGN_AWARD_TEXT_COUNT];
extern H2_CONST char* cSlowVideoLevelText[KB_SLOW_VIDEO_LEVEL_TEXT_COUNT];
extern H2_CONST char* gSPanelHelp[KB_SETTINGS_PANEL_HELP_COUNT];
extern H2_CONST char* xBarrierColor[KB_BARRIER_COLOR_NAME_COUNT];
extern H2_CONST char* xGenericSiteNames[KB_GENERIC_SITE_NAME_COUNT];
extern H2_CONST char* xRecruitEmpty[X_GLOBAL_RECRUIT_EMPTY_COUNT];
extern H2_CONST char* xRecruitBuy[X_GLOBAL_RECRUIT_BUY_COUNT];
extern H2_CONST char* xRecruitmentSiteNames[KB_RECRUITMENT_SITE_NAME_COUNT];
