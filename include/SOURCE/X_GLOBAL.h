...
extern char* gArtifactNames[IDX(ARTIFACT_COUNT)];
extern char* gArtifactDesc[IDX(ARTIFACT_COUNT)];
extern char* gArtifactEvent[IDX(ARTIFACT_COUNT)];
...
extern char* gTerrainNames[IDX(TERRAIN_COUNT)];
