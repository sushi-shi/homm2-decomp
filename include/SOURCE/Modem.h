...
H2_ENUM_END(ModemConnectionStage)

H2_ENUM_BEGIN(ModemTimingConstant)
    MODEM_BAUD_CLOCK       = 115200,
    MODEM_COMMAND_INTERVAL = 250,
    MODEM_COMMAND_DELAY    = 100,
    MODEM_RESET_DELAY      = 200,
H2_ENUM_END(ModemTimingConstant)

H2_ENUM_BEGIN(ModemStorageConstant)
...
H2_ENUM_END(ModemStorageConstant)

H2_ENUM_BEGIN(ModemPacketEncodingConstant)
    MODEM_ID_MODULUS  = 1000000,
    MODEM_ESCAPE_BYTE = 0x70,
    MODEM_PACKET_END  = 1,
H2_ENUM_END(ModemPacketEncodingConstant)
