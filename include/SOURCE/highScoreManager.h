...
typedef enum HighScoreManagerConstant {
    ...
    HIGH_SCORE_MESSAGE_WIDGET = 0x200,
    HIGH_SCORE_MESSAGE_EXECUTIVE = 0x4000,
    HIGH_SCORE_EXECUTIVE_CLOSE = 4,
    HIGH_SCORE_WIDGET_SET_TEXT = 3,
...
public:
    ...
    short m_animationFrames[HIGH_SCORE_DISPLAY_ENTRY_COUNT];  // +0x36
    short m_monsterTypes[HIGH_SCORE_DISPLAY_ENTRY_COUNT];  // +0x4a
