...
H2_ENUM_BEGIN(HighScoreControlId)
    ...
    HIGH_SCORE_ANIMATED_WIDGET_LAST  = 230,
H2_ENUM_END(HighScoreControlId)
...
H2_ENUM_BEGIN(HighScoreAnimationConstant)
...
H2_ENUM_END(HighScoreAnimationConstant)

H2_ENUM_BEGIN(HighScoreLayoutConstant)
...
H2_ENUM_END(HighScoreLayoutConstant)
