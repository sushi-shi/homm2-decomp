...
HOMM2_ENUM_VALUES_BEGIN(CombatCastleInteriorRange)
...
HOMM2_ENUM_VALUES_END(CombatCastleInteriorRange)

HOMM2_ENUM_VALUES_BEGIN(CombatCastleWallSlot)
...
HOMM2_ENUM_VALUES_END(CombatCastleWallSlot)
