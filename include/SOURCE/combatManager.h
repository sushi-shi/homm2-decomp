...
H2_ENUM_BEGIN(CombatManagerStorageConstant)
...
H2_ENUM_END(CombatManagerStorageConstant)

H2_ENUM_BEGIN(CombatHeroPlacementConstant)
...
H2_ENUM_END(CombatHeroPlacementConstant)

H2_ENUM_BEGIN(CombatSiegeDrawingConstant)
...
H2_ENUM_END(CombatSiegeDrawingConstant)

H2_ENUM_BEGIN(CombatObstaclePlacementConstant)
...
H2_ENUM_END(CombatObstaclePlacementConstant)

H2_ENUM_BEGIN(CombatBattleSetupConstant)
...
H2_ENUM_END(CombatBattleSetupConstant)

H2_ENUM_BEGIN(CombatMissileDirectionConstant)
    COMBAT_MISSILE_DIRECTION_COUNT = 9,
    COMBAT_MISSILE_LAST_DIRECTION  = 8,
    COMBAT_MISSILE_SPACING_ROUND   = 15,
H2_ENUM_END(CombatMissileDirectionConstant)

H2_ENUM_BEGIN(CombatSmallViewConstant)
...
H2_ENUM_END(CombatSmallViewConstant)

H2_ENUM_BEGIN(CombatMessageDisplayConstant)
...
H2_ENUM_END(CombatMessageDisplayConstant)
...
// Only the range/column contract; no occupancy, passability or ValidHex call.
...
// The gate exception uses the global manager, independently of the caller's cell receiver.
#define CAN_PASS_CASTLE_GATE(hex)                                                                  \
    (gpCombatManager->m_inCastleCombat                                                             \
     && ((hex) == COMBAT_CASTLE_GATE_APPROACH_HEX || (hex) == IDX(COMBAT_CASTLE_HEX_GATE))         \
