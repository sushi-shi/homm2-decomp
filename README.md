...
**Overall: 7 / 1495 functions exact (0.47%) &middot; 0.11% of code bytes.**

| Module | Units | Functions exact | Code |
| :----- | ----: | --------------: | ---: |
| `SOURCE` | 50 | 0 / 1039 (0.0%) | 0.0% |
| `BASE` | 44 | 0 / 445 (0.0%) | 0.0% |
| `EDITOR` | 1 | 7 / 11 (63.6%) | 29.2% |
...
include/  {BASE,SOURCE,EDITOR}   recovered class headers (vtables, OVERRIDE) + rva.h / Ints.h
