...
decomp-pol-2.0 -------------------> decomp-gold-2.1-buka
    ...
    |                  |                |                        |
    v                  v                v                        v
source-pol-2.0     classic-pol-2.0   source-gold-2.1-buka    classic-gold-2.1-buka (you are here)
    |                                   |
    +-----------------+-----------------+
                      |
                      v
...
This generated branch builds the original 32-bit Windows target. With Nix:
