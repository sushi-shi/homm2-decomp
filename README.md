...
**Overall: 1446 / 1727 functions exact (83.73%) &middot; 1446 / 1727 functions exact-max (83.73%) &middot; 93.64% fuzzy &middot; 93.65% fuzzy-max &middot; 0 / 0 data bytes (0.000%) &middot; 0 / 0 data-bearing units exact.**
...
| :------- | ----: | -----------------: | ------------------: | -----: | --------: | ---------: | ------------: |
| `SOURCE` |    50 | 961 / 1155 (83.2%) |  961 / 1155 (83.2%) |  94.6% |     94.6% |      0 / 0 | 0 / 0 (0.00%) |
