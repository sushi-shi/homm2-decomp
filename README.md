...
**Overall: 963 / 1514 functions exact (63.61%) &middot; 1014 / 1514 functions exact-max (66.97%) &middot; 97.69% fuzzy &middot; 98.08% fuzzy-max &middot; 306,820 / 306,820 data bytes (100.000%) &middot; 89 / 89 data-bearing units exact.**

_**Functions exact** = byte-identical now. **Functions exact-max** = observed at 100% at least once for the current source hash. **Fuzzy** is the live size-weighted instruction match; **fuzzy-max** retains each function's best observed score for its current source hash. Maxima are historical navigation data, not correctness proof or enforcement._

| Module   | Units |    Functions exact | Functions exact-max | Fuzzy | Fuzzy-max | Data exact |                  Data bytes |
| :------- | ----: | -----------------: | ------------------: | ----: | --------: | ---------: | --------------------------: |
| `SOURCE` |    50 | 644 / 1058 (60.9%) |  683 / 1058 (64.6%) | 98.0% |     98.4% |    47 / 47 | 272,406 / 272,406 (100.00%) |
| `BASE`   |    44 |  313 / 445 (70.3%) |   325 / 445 (73.0%) | 95.6% |     95.8% |    42 / 42 |   34,414 / 34,414 (100.00%) |
| `EDITOR` |     1 |     6 / 11 (54.5%) |      6 / 11 (54.5%) | 98.5% |     98.5% |      0 / 0 |               0 / 0 (0.00%) |
