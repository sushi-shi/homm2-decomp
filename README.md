...
**Overall: 957 / 1514 functions exact (63.21%) &middot; 97.95% fuzzy &middot; 306,820 / 306,820 data bytes (100.000%) &middot; 89 / 89 data-bearing units exact.**

_**Functions exact** = byte-identical now. **Fuzzy** = the live size-weighted instruction match; neither metric replaces raw-byte and relocation review._

| Module   | Units |    Functions exact | Fuzzy | Data exact |                  Data bytes |
| :------- | ----: | -----------------: | ----: | ---------: | --------------------------: |
| `SOURCE` |    50 | 645 / 1058 (61.0%) | 98.3% |    47 / 47 | 272,406 / 272,406 (100.00%) |
| `BASE`   |    44 |  306 / 445 (68.8%) | 95.4% |    42 / 42 |   34,414 / 34,414 (100.00%) |
| `EDITOR` |     1 |     6 / 11 (54.5%) | 98.5% |      0 / 0 |               0 / 0 (0.00%) |
