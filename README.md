...
**Overall: 1027 / 1514 functions exact (67.83%) &middot; 1111 / 1514 functions exact-max (73.38%) &middot; 97.91% fuzzy &middot; 98.36% fuzzy-max &middot; 306,820 / 306,820 data bytes (100.000%) &middot; 89 / 89 data-bearing units exact.**

_**Functions exact** = byte-identical now. **Functions exact-max** = observed at 100% at least once for the current source hash, including audited exact disposable TU-state probes. **Fuzzy** is the live size-weighted instruction match; **fuzzy-max** retains each function's best observed score for its current source hash. Maxima are historical navigation data, not correctness proof or enforcement._

| Module   | Units |    Functions exact | Functions exact-max | Fuzzy | Fuzzy-max | Data exact |                  Data bytes |
| :------- | ----: | -----------------: | ------------------: | ----: | --------: | ---------: | --------------------------: |
| `SOURCE` |    50 | 700 / 1058 (66.2%) |  755 / 1058 (71.4%) | 98.2% |     98.6% |    47 / 47 | 272,406 / 272,406 (100.00%) |
| `BASE`   |    44 |  319 / 445 (71.7%) |   348 / 445 (78.2%) | 95.8% |     96.2% |    42 / 42 |   34,414 / 34,414 (100.00%) |
