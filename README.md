...
**Overall: 1414 / 1727 functions exact (81.88%) &middot; 1414 / 1727 functions exact-max (81.88%) &middot; 92.58% fuzzy &middot; 92.58% fuzzy-max &middot; 0 / 0 data bytes (0.000%) &middot; 0 / 0 data-bearing units exact.**
...
| :------- | ----: | -----------------: | ------------------: | -----: | --------: | ---------: | ------------: |
| `SOURCE` |    50 | 938 / 1155 (81.2%) |  938 / 1155 (81.2%) |  93.5% |     93.5% |      0 / 0 | 0 / 0 (0.00%) |
