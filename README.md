...
**Overall: 184 / 1890 functions exact (9.74%) &middot; 184 / 1890 functions exact-max (9.74%) &middot; 76.81% fuzzy &middot; 76.81% fuzzy-max &middot; 0 / 0 data bytes (0.000%) &middot; 0 / 0 data-bearing units exact.**
...
| `(libcmt)`   |       248 |   37,747 | FID-identified static runtime (config/crt_functions.csv) |
