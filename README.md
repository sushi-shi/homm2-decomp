...
**Overall: 823 / 1514 functions exact (54.36%) &middot; 950 / 1514 functions exact-max (62.75%) &middot; 97.87% fuzzy &middot; 98.42% fuzzy-max.**
...
| :------- | ----: | -----------------: | ------------------: | -----: | --------: |
| `SOURCE` |    50 | 522 / 1058 (49.3%) |  613 / 1058 (57.9%) |  98.2% |     98.7% |
...
The deterministic Gruntz-style release builder is
