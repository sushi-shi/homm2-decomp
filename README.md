...
**Overall: 1451 / 1727 functions exact (84.02%) &middot; 1451 / 1727 functions exact-max (84.02%) &middot; 94.20% fuzzy &middot; 94.20% fuzzy-max &middot; 0 / 0 data bytes (0.000%) &middot; 0 / 0 data-bearing units exact.**
...
| :------- | ----: | -----------------: | ------------------: | -----: | --------: | ---------: | ------------: |
| `SOURCE` |    50 | 966 / 1155 (83.6%) |  966 / 1155 (83.6%) |  95.2% |     95.2% |      0 / 0 | 0 / 0 (0.00%) |
