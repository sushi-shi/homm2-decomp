...
| [chained-assignment-vs-repeated-literal](chained-assignment-vs-repeated-literal.md) | second store of the same constant reloads the sibling field instead of carrying an immediate -> the source repeats the literal, it does not chain `a = b` |
