...
| msvc42-tu-state-noise-search | topic:tu-state topic:last-mile topic:tooling | Temporary parser-visible declaration/include probes perturb VC42 TU state; sub-100 compiled output is deleted, and only a size/relocation-proven exact 100 preserves an audit artifact and may close the unchanged target |
