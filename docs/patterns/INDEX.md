...
| msvc42-tu-state-noise-search | topic:tu-state topic:last-mile topic:tooling | Bounded, reversible preprocessor-only TU-state probes with exact target selection, sibling/relocation guards, and an unapplied best-candidate patch |
