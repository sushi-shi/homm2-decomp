// VC6 SP5 source family c76-newgame-human-count; parent f84e0b7c plus U18 incoming packet header.
...
// build/source-variant-batch/c76-newgame-human-count/results.json; RVA 0x756e8
// Complete 2 arms; elapsed 1.932405s; source restored.
...
// 1 / {'family': 'remove_both', 'candidate': 'baseline'} / 1028 / af3cc992987c1223 / a6e63cfbc9b5371e / 60:60 / 60,0,0,0 / True
...
// | }
// |
// ALTERNATIVE remove_both (unified delta from BEFORE):
// | --- before
// | +++ remove_both
// | @@ -52,7 +52,7 @@
// |              if (m_mapHeader.playerCanHuman[m_setupPlayerColor[player]]
