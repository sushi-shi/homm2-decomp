// VC6 SP5 source family s69-newgame-newgame-packet; parent f84e0b7c plus U18 incoming packet header.
...
// build/source-variant-batch/s69-newgame-newgame-packet/results.json; RVA 0x75b4b
// Complete 2 arms; elapsed 1.876366s; source restored.
...
// 1 / {'family': 'remove_1', 'candidate': 'baseline'} / 2673 / c72a456d430d7608 / f12e7436ced3db53 / 91:91 / 91,0,0,0 / True
...
// |  i32 game::NewGame(void) {
// | -    char netPlayerPacket[GAME_PLAYER_INFO_BUFFER_SIZE];
// | +    char netPlayerPacket[GAME_PLAYER_INFO_PACKET_SIZE];
// |      char mapInfo[GAME_MAP_PACKET_SIZE];
// |      tag_message windowMessage;
// |      b32 mapHeaderOk;
