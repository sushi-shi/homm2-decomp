// VC6 SP5 Castle source family c69-castle-control-range; parent f8b6c956.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/c69-castle-control-range/results.json; RVA 0x25230
// Complete 8 arms; elapsed 4.794236s; input restored.
...
// 1 / {'source_family': 'button', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / bd66b8c47b74d687 / 127:130 / 123,0,0,4 / False
// 2 / {'source_family': 'icon', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / bd66b8c47b74d687 / 127:130 / 123,0,0,4 / False
// 3 / {'source_family': 'icon_button', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / 37c68674ce4c9cd0 / 127:130 / 123,0,0,4 / False
// 4 / {'source_family': 'name', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / bd66b8c47b74d687 / 127:130 / 123,0,0,4 / False
// 5 / {'source_family': 'name_button', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / 37c68674ce4c9cd0 / 127:130 / 123,0,0,4 / False
// 6 / {'source_family': 'name_icon', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / 37c68674ce4c9cd0 / 127:130 / 123,0,0,4 / False
// 7 / {'source_family': 'name_icon_button', 'candidate': 'baseline'} / 2925 / 1a52b2757d2aa26c / 7f88dde823314151 / 127:130 / 123,0,0,4 / False
...
// |     return MESSAGE_DISPATCH_CONSUME;
// | }
// ALTERNATIVE button (unified source delta from BEFORE):
// | --- before
// | +++ button
// | @@ -34,7 +34,7 @@
// |                  whichBuilding = message.payload.widget.id - CONTROL_BUILDING_ICON_FIRST;
...
// |              if (whichBuilding != IDX(BUILDING_SLOT_NONE))
// |                  whichBuilding = IDX(castleSlotsUse[whichBuilding]);
// ALTERNATIVE icon (unified source delta from BEFORE):
// | --- before
// | +++ icon
// | @@ -30,7 +30,7 @@
// |                  whichBuilding = message.payload.widget.id - CONTROL_BUILDING_NAME_FIRST;
...
// |              else if (message.payload.widget.id >= CONTROL_BUILDING_BUTTON_FIRST
// |                       && message.payload.widget.id
// ALTERNATIVE icon_button (unified source delta from BEFORE):
// | --- before
// | +++ icon_button
// | @@ -30,11 +30,11 @@
// |                  whichBuilding = message.payload.widget.id - CONTROL_BUILDING_NAME_FIRST;
...
// |              if (whichBuilding != IDX(BUILDING_SLOT_NONE))
// |                  whichBuilding = IDX(castleSlotsUse[whichBuilding]);
// ALTERNATIVE name (unified source delta from BEFORE):
// | --- before
// | +++ name
// | @@ -26,7 +26,7 @@
// |          else {
...
// |              else if (message.payload.widget.id >= CONTROL_BUILDING_ICON_FIRST
// |                       && message.payload.widget.id
// ALTERNATIVE name_button (unified source delta from BEFORE):
// | --- before
// | +++ name_button
// | @@ -26,7 +26,7 @@
// |          else {
...
// |              if (whichBuilding != IDX(BUILDING_SLOT_NONE))
// |                  whichBuilding = IDX(castleSlotsUse[whichBuilding]);
// ALTERNATIVE name_icon (unified source delta from BEFORE):
// | --- before
// | +++ name_icon
// | @@ -26,11 +26,11 @@
// |          else {
...
// |              else if (message.payload.widget.id >= CONTROL_BUILDING_BUTTON_FIRST
// |                       && message.payload.widget.id
// ALTERNATIVE name_icon_button (unified source delta from BEFORE):
// | --- before
// | +++ name_icon_button
// | @@ -26,15 +26,15 @@
// |          else {
