// VC6 SP5 Castle source family g82-g83-castle-hero-joins; parent f8b6c956.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/g82-g83-castle-hero-joins/results.json; RVA 0x25230
// Complete 4 arms; elapsed 2.68936s; input restored.
...
// 1 / {'source_family': 'hero_selected', 'candidate': 'baseline'} / 2913 / 3423d15984a3c661 / 4556222893278cb9 / 128:130 / 88,1,22,17 / False
// 2 / {'source_family': 'hero_hover_text', 'candidate': 'baseline'} / 2915 / d7a1ca540fc66299 / 220351e14ccab0b9 / 124:130 / 46,1,25,52 / False
// 3 / {'source_family': 'hero_hover_text_hero_selected', 'candidate': 'baseline'} / 2903 / 7bca844cd3e778c2 / 8ed8b3b913eec2e1 / 125:130 / 55,3,25,42 / False
...
// |     return MESSAGE_DISPATCH_CONSUME;
// | }
// ALTERNATIVE hero_selected (unified source delta from BEFORE):
// | --- before
// | +++ hero_selected
// | @@ -339,12 +339,11 @@
// |                          switch (message.payload.widget.id) {
...
// |                                      HeroView(gpCurPlayer->AvailableHeroId(heroChoiceIndex), true, false);
// |                                      casWin->DrawWindow();
// ALTERNATIVE hero_hover_text (unified source delta from BEFORE):
// | --- before
// | +++ hero_hover_text
// | @@ -162,12 +162,11 @@
// |                  switch (message.payload.widget.id) {
...
// |                              strcpy(gText, cCastleInfo[IDX(INFO_CANNOT_AFFORD_HERO)]);
// |                          } else if (gpCurPlayer->m_heroCount == PLAYER_HERO_CAPACITY) {
// ALTERNATIVE hero_hover_text_hero_selected (unified source delta from BEFORE):
// | --- before
// | +++ hero_hover_text_hero_selected
// | @@ -162,12 +162,11 @@
// |                  switch (message.payload.widget.id) {
// |                      case CONTROL_HERO_FIRST:
// |                      case CONTROL_HERO_FIRST + 1:
