// VC6 SP5 Castle source family s63-castle-handler-storage; parent f8b6c956.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/s63-castle-handler-storage/results.json; RVA 0x25230
// Complete 4 arms; elapsed 2.563654s; input restored.
...
// 1 / {'source_family': 'unused_search', 'candidate': 'baseline'} / 2866 / ad45dfa53e79f471 / 37de200be87e3f0e / 121:130 / 82,0,18,21 / False
// 2 / {'source_family': 'status', 'candidate': 'baseline'} / 2919 / 2fc49b19a73d2922 / b149a4579cff7018 / 127:130 / 122,1,0,4 / False
// 3 / {'source_family': 'status_unused_search', 'candidate': 'baseline'} / 2860 / bfb21d054cd1a73d / 26857ef0ac70000e / 121:130 / 81,1,18,21 / False
...
// |     return MESSAGE_DISPATCH_CONSUME;
// | }
// ALTERNATIVE unused_search (unified source delta from BEFORE):
// | --- before
// | +++ unused_search
// | @@ -322,12 +322,6 @@
// |                                  break;
...
// |                              static_cast<BuildingSlotType>(whichBuilding),
// |                              (gpTownManager->m_affordableBuildings & BIT(whichBuilding)) == 0,
// ALTERNATIVE status (unified source delta from BEFORE):
// | --- before
// | +++ status
// | @@ -5,9 +5,7 @@
// |      i32 whichBuilding;
...
// |      ret = 0;
// |      hoverMessage = false;
// ALTERNATIVE status_unused_search (unified source delta from BEFORE):
// | --- before
// | +++ status_unused_search
// | @@ -5,9 +5,7 @@
// |      i32 whichBuilding;
// |      b32 quickFlag;
// |      i32 ret;
