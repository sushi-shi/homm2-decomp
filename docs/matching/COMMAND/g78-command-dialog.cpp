// VC6 SP5 COMMAND source family g78-command-dialog; parent34b6e303 plus U17 packet view.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/g78-command-dialog/results.json; RVA 0x2de7d
// Complete 2 arms; elapsed 2.064589s; input restored.
// Disposition: retain original; every tested alternative changes text.
// EH private symbol hashes may differ; native comparison canonicalizes actual section owners.
// trial / choices / bytes / text hash / normalized reloc hash / blocks / exact,size,shift,flow / graph exact
// 0 / {'structured_control': 'keep', 'candidate': 'baseline'} / 1267 / e39b7938cb338175 / 5f4350f4e043df12 / 51:51 / 51,0,0,0 / True
// 1 / {'structured_control': 'shared_exit_after_advance_breaks', 'candidate': 'baseline'} / 1259 / a50a054be15ec202 / 52edce0b5e6c3684 / 49:51 / 4,3,12,30 / False
...
// | }
// ALTERNATIVE shared_exit_after_advance_breaks (unified source delta from BEFORE):
// | --- before
// | +++ shared_exit_after_advance_breaks
// | @@ -19,42 +19,35 @@
// |              case WIDGET_COMMAND_DESELECT:
// |                  switch (message.payload.widget.id) {
// |                      case WIN_LOSE_NEXT_CONTROL:
...
// | +                                break;
// | +                            }
// | +                            if (giSkeletonsCreated != 0 && bSkeletonsShown == 0) {
// | +                                bSkeletonsShown = true;
// | +                                gpCombatManager->ClearWinLoseBottom(gpCombatManager->m_winLoseWindow);
// | +                                gpCombatManager->ShowSkeletons(gpCombatManager->m_winLoseWindow);
// | +                                break;
...
// | -                                    ->m_eagleEyeSpell[IDX(gpCombatManager->m_combatResult)] =
// | +                                gpCombatManager->ClearWinLoseBottom(gpCombatManager->m_winLoseWindow);
// | +                                gpCombatManager->ShowEagleEyeSpell(gpCombatManager->m_winLoseWindow);
