// VC6 SP5 COMMAND source family c68-command-domain; parent34b6e303 plus U17 packet view.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/c68-command-domain/results.json; RVA 0x2d56e
// Complete 3 arms; elapsed 2.977545s; input restored.
// Disposition: retain original; every tested alternative changes text.
// EH private symbol hashes may differ; native comparison canonicalizes actual section owners.
// trial / choices / bytes / text hash / normalized reloc hash / blocks / exact,size,shift,flow / graph exact
// 0 / {'enum_conditional': 'keep', 'candidate': 'baseline'} / 1014 / 5ba0c6a613982b3c / 37b27283eb4d4b55 / 65:65 / 65,0,0,0 / True
// 1 / {'enum_conditional': 'remove_byte_casts', 'candidate': 'baseline'} / 1014 / 226a7c2bbfdadf6a / 37b27283eb4d4b55 / 65:65 / 65,0,0,0 / True
// 2 / {'enum_conditional': 'typed_command_constants', 'candidate': 'baseline'} / 1014 / 226a7c2bbfdadf6a / 37b27283eb4d4b55 / 65:65 / 65,0,0,0 / True

// AXIS enum_conditional
...
// |     return command;
// | }
// ALTERNATIVE remove_byte_casts (unified source delta from BEFORE):
// | --- before
// | +++ remove_byte_casts
// | @@ -115,8 +115,8 @@
// |                          HAS(m_armies[IDX(m_currentArmySide)][m_currentArmyIndex]
...
// |                  }
// |              }
// ALTERNATIVE typed_command_constants (unified source delta from BEFORE):
// | --- before
// | +++ typed_command_constants
// | @@ -111,13 +111,12 @@
// |                  if (m_armies[IDX(m_currentArmySide)][m_currentArmyIndex]
// |                          .ValidPath(hexIndex, ARMY_PATH_ANY_TARGET_HEX)
// |                      == 1) {
