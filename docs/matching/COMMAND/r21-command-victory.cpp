// VC6 SP5 COMMAND source family r21-command-victory; parent34b6e303 plus U17 packet view.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/r21-command-victory/results.json; RVA 0x2f601
// Complete 2 arms; elapsed 2.097292s; input restored.
// Disposition: retain original; every tested alternative changes text.
// EH private symbol hashes may differ; native comparison canonicalizes actual section owners.
// trial / choices / bytes / text hash / normalized reloc hash / blocks / exact,size,shift,flow / graph exact
// 0 / {'semantic_counter_scope': 'keep', 'candidate': 'baseline'} / 2839 / 4f4d2a3363b8ba73 / 6c4a6115d48fc8ae / 117:117 / 117,0,0,0 / True
// 1 / {'semantic_counter_scope': 'separate_counter', 'candidate': 'baseline'} / 2839 / d6876a5dd32afa7d / 6a9ee9fd7b8f571d / 117:117 / 117,0,0,0 / True
...
// |      waitTimer = KBTickCount();
// | -    for (loop = 0; loop < numFades; ++loop) {
// | +    for (i32 fadeStep = 0; fadeStep < numFades; ++fadeStep) {
// |          PollSound();
// |          DelayTil(&waitTimer);
// |          waitTimer = KBTickCount() + VICTORY_FADE_DELAY;
