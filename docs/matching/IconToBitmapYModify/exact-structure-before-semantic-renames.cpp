/*
 * Audited exact IconToBitmapYModify source before semantic scratch renames.
 *
 * Effective-source hash: 15fda1250f72.852e9521ff86.
 * TU-state trial 39 reached retail size 1416, exact bytes, and all 130 ordered
 * relocations. This file is retained as the family structural reference while
 * the live explicit decoder tests semantic s_* identifiers and fresh islands.
 */
