// VC6 SP5 source family g92-drawing-frame-finish; parent aab81af5.
...
// build/source-variant-batch/g92-drawing-frame-finish/results.json; RVA 0x395b8
// Complete 2 arms; elapsed 1.739351s; source restored.
...
// 1 / {'source_family': 'single_pass', 'candidate': 'baseline'} / 5412 / 471e164aa404e850 / 5e546ce89f1b9911 / 206:206 / 12,6,61,127 / False
...
// |     PollSound();
// | }
// ALTERNATIVE single_pass (unified delta from BEFORE):
// | --- before
// | +++ single_pass
// | @@ -33,6 +33,7 @@
// |      PollSound();
