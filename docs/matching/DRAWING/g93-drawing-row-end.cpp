// VC6 SP5 source family g93-drawing-row-end; parent aab81af5.
...
// build/source-variant-batch/g93-drawing-row-end/results.json; RVA 0x395b8
// Complete 2 arms; elapsed 1.832637s; source restored.
...
// 1 / {'source_family': 'row_scope', 'candidate': 'baseline'} / 5372 / 83b95496b3931d0e / aeeec54e0679012a / 197:206 / 171,0,23,3 / False
...
// |     PollSound();
// | }
// ALTERNATIVE row_scope (unified delta from BEFORE):
// | --- before
// | +++ row_scope
// | @@ -423,11 +423,12 @@
// |              }
