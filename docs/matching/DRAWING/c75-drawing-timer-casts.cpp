// VC6 SP5 source family c75-drawing-timer-casts; parent aab81af5.
...
// build/source-variant-batch/c75-drawing-timer-casts/results.json; RVA 0x395b8
// Complete 4 arms; elapsed 2.971399s; source restored.
// Disposition: retain all cast removals; combined all98 native objects unchanged.
...
// 1 / {'source_family': '1', 'candidate': 'baseline'} / 5406 / 430b7ec7cb606625 / a1d59bf8ba2f4f2d / 206:206 / 205,1,0,0 / True
// 2 / {'source_family': '0', 'candidate': 'baseline'} / 5406 / 430b7ec7cb606625 / a1d59bf8ba2f4f2d / 206:206 / 205,1,0,0 / True
// 3 / {'source_family': '0_1', 'candidate': 'baseline'} / 5406 / 430b7ec7cb606625 / cc733aca509b6c6e / 206:206 / 205,1,0,0 / True
...
// |     PollSound();
// | }
// ALTERNATIVE 1 (unified delta from BEFORE):
// | --- before
// | +++ 1
// | @@ -533,7 +533,7 @@
// |              DelayTil(glTimers);
...
// |      }
// |
// ALTERNATIVE 0 (unified delta from BEFORE):
// | --- before
// | +++ 0
// | @@ -514,7 +514,7 @@
// |          if (waitForTimer != 0)
...
// |          if (updateScreen == 1) {
// |              if (giMaxExtentY > COMBAT_MAX_EXTENT_Y)
// ALTERNATIVE 0_1 (unified delta from BEFORE):
// | --- before
// | +++ 0_1
// | @@ -514,7 +514,7 @@
// |          if (waitForTimer != 0)
