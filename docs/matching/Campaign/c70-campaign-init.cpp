// VC6 SP5 Campaign source family c70-campaign-init; parent d7472bf9.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/c70-campaign-init/results.json; RVA 0x2387e
// Complete 4 arms; elapsed 2.85684s; input restored.
...
// 1 / {'source_family': 'puzzle', 'candidate': 'baseline'} / 2653 / 48b0bea1b939c5c0 / b729e871d49583eb / 120:118 / 116,0,0,2 / False
// 2 / {'source_family': 'hero', 'candidate': 'baseline'} / 2653 / 48b0bea1b939c5c0 / 0d80794df1c3c9a5 / 120:118 / 116,0,0,2 / False
// 3 / {'source_family': 'hero_puzzle', 'candidate': 'baseline'} / 2653 / 48b0bea1b939c5c0 / a90072611df39184 / 120:118 / 116,0,0,2 / False
...
// | }
// ALTERNATIVE puzzle (unified source delta from BEFORE):
// | --- before
// | +++ puzzle
// | @@ -145,7 +145,7 @@
// |                      ->m_army.Add(choiceBest1->creature, choiceBest1->amount, -1);
...
// |          case CAMPAIGN_CHOICE_PUZZLE_PIECES:
// | -            m_players[0].m_cheatValue = static_cast<i8>(choiceBest1->value);
// | +            m_players[0].m_cheatValue = choiceBest1->value;
// |              break;
// |          case CAMPAIGN_CHOICE_EXPERIENCE: {
// |              savedNewGameSetup = gbInNewGameSetup;
// ALTERNATIVE hero (unified source delta from BEFORE):
// | --- before
// | +++ hero
// | @@ -101,7 +101,7 @@
// |              campaignPlayerCurrent9->m_heroIds[heroPositionValue] =
...
// |      }
// |      if (campaignPlayerCurrent9->m_heroCount)
// ALTERNATIVE hero_puzzle (unified source delta from BEFORE):
// | --- before
// | +++ hero_puzzle
// | @@ -101,7 +101,7 @@
// |              campaignPlayerCurrent9->m_heroIds[heroPositionValue] =
