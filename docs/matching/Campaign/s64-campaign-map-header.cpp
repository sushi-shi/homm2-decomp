// VC6 SP5 Campaign source family s64-campaign-map-header; parent d7472bf9.
// Source record only. All alternatives below are relative to the stated BEFORE,
// not cumulative diffs. No cross-family/TU-state census is claimed.
// build/source-variant-batch/s64-campaign-map-header/results.json; RVA 0x2387e
// Complete 2 arms; elapsed 1.800922s; input restored.
...
// 1 / {'source_family': 'unused_result', 'candidate': 'baseline'} / 2650 / 391d456993456da5 / f82ce6306aae93fa / 120:118 / 115,1,0,2 / False
...
// | }
// ALTERNATIVE unused_result (unified source delta from BEFORE):
// | --- before
// | +++ unused_result
// | @@ -10,7 +10,6 @@
// |      i32 heroPriorityBest3;
