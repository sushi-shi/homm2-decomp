"""Compare kbwin source diagnostics with the reviewed pre-edit parent.
...
root=Path.cwd()
source=root/'src/SOURCE/kbwin.cpp'
parent=subprocess.check_output(['git','show','f0502d36:src/SOURCE/kbwin.cpp'],text=True)
configure_libclang()
