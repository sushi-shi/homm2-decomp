"""Compare Overview source diagnostics with the reviewed pre-edit parent.
...
root=Path.cwd()
source=root/'src/SOURCE/Overview.cpp'
parent=subprocess.check_output(['git','show','ee5ee1cf:src/SOURCE/Overview.cpp'],text=True)
configure_libclang()
