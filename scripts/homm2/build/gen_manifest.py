...
def profile_of(unit):
    ...
    # yet the empirically selected reproduction profiles below differ (BITS uses
    # inline assembly under an optimized frame-pointer profile; TILE /O2;
    # FONT/RESMGR /Od plus /Oi). CodeView does not prove the literal optimization
    # flags. Keep the selected profiles across init.
