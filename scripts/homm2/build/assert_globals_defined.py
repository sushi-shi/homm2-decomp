...
build/objdiff/base/<owner-unit>.obj. Synthetic globals (no CodeView symbol -> _globals_model.h)
and the _const pseudo-unit are exempt (they alias real storage / have no owning TU). Runs after
...
# globals declared `extern` in a header (skip _globals_model.h — synthetic, no owning TU)
declared = {}
