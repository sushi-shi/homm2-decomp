...
static char gExecutiveTextStorage[sizeof(SExecutiveText)] =
    "не могу инициализировать ресурсы. Вероятно, ошибка диска." "\0\0\0"
    "Не могу инициализировать устройства ввода. Вероятно, проблема с клавиатурой или мышью." "\0\0"
    "Не могу инициализировать звук." "\0\0"
    "Не могу инициализировать мышь." "\0\0"
    "Не могу инициализировать окна. Вероятно, ошибка диска или памяти." "\0\0\0"
    "Не могу добавить менеджера!" "\0"
    "Не могу добавить менеджера!" "\0"
    "Не могу добавить менеджера!" "\0"
    "Не могу добавить менеджера!" "\0"
