...
static char gExecutiveResourceInitError[EXEC_TEXT_RESOURCE_INIT_SLOT_SIZE] = "не могу инициализировать ресурсы. Вероятно, ошибка диска.";
static char gExecutiveInputInitError[EXEC_TEXT_INPUT_INIT_SLOT_SIZE] = "Не могу инициализировать устройства ввода. Вероятно, проблема с клавиатурой или мышью.";
static char gExecutiveSoundInitError[EXEC_TEXT_DEVICE_INIT_SLOT_SIZE] = "Не могу инициализировать звук.";
static char gExecutiveMouseInitError[EXEC_TEXT_DEVICE_INIT_SLOT_SIZE] = "Не могу инициализировать мышь.";
static char gExecutiveWindowInitError[EXEC_TEXT_WINDOW_INIT_SLOT_SIZE] = "Не могу инициализировать окна. Вероятно, ошибка диска или памяти.";
static char gExecutiveDialogManagerError1[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
static char gExecutiveDialogManagerError2[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
static char gExecutiveDialogManagerError3[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
static char gExecutiveDialogManagerError4[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
...
static char gExecutiveCallManagerError1[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
static char gExecutiveCallManagerError2[EXEC_TEXT_MANAGER_ERROR_SLOT_SIZE] = "Не могу добавить менеджера!";
