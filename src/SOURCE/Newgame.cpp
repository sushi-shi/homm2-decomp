        ...
        switch (m_mapHeader.lossCondition) {
            case MAP_LOSS_TOWN:
                ...
                sprintf(
                    ...
                    (H2EnumIndex((city2->m_buildings) & (H2EnumIndex(TOWN_BUILDING_CASTLE)))) ? localization::Tr("scenario.fragment.castle")
        ...
        switch (m_mapHeader.victoryCondition) {
            case MAP_VICTORY_CAPTURE_TOWN:
                ...
                sprintf(
                    ...
                    (H2EnumIndex((targetTown->m_buildings) & (H2EnumIndex(TOWN_BUILDING_CASTLE))))
