...
DATA(0x0051d560) SCampaignChoice xCampaignChoices[IDX(
    ...
    {{{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MEDAL_OF_VALOR, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_STEALTH_SHIELD, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MINOR_SCROLL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_WHITE_PEARL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_BALLISTA, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}},
     {{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MAGE_RING, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MAJOR_SCROLL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LOGISTICS, HERO_SKILL_LEVEL_ADVANCED}},
     {{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MEDAL_OF_HONOR, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_CASTER_BRACELET, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_DEFENDER_HELM, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, HERO_PRIMARY_DEFENSE, EXPANSION_CAMPAIGN_PRIMARY_BONUS_TWO}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      {CAMPAIGN_CHOICE_CREATURES, CREATURE_CRUSADER, EXPANSION_CAMPAIGN_CRUSADER_COUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_TRAVELER_BOOTS, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_SULFUR, EXPANSION_CAMPAIGN_SULFUR_TEN},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL_SCROLL, SPELL_ANIMATE_DEAD, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SPELL, SPELL_VIEW_HEROES, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_CREATURES, CREATURE_MAGE, EXPANSION_CAMPAIGN_MAGE_COUNT},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_ESTATES, HERO_SKILL_LEVEL_ADVANCED}}},
    {{{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_WOOD_FIFTY},
      {CAMPAIGN_CHOICE_RESOURCE, RES_CRYSTAL, EXPANSION_CAMPAIGN_CRYSTAL_TEN}},
     {{CAMPAIGN_CHOICE_PRIMARY_SKILL, HERO_PRIMARY_ATTACK, EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, HERO_PRIMARY_DEFENSE, EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LOGISTICS, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SPELL, SPELL_STEEL_SKIN, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MAGE_RING, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LOGISTICS, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_SCOUTING, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LUCK, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LEADERSHIP, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_SPIKED_SHIELD, EXPANSION_CAMPAIGN_ARTIFACT_AMOUNT_ONE}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_PENALTY_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_WOOD_PENALTY_TEN},
      {CAMPAIGN_CHOICE_RESOURCE, RES_MERCURY, EXPANSION_CAMPAIGN_MERCURY_PENALTY_TWO}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_SCOUTING, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_WOOD_TWENTY}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LEADERSHIP, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_ARCHERY, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL,
       HERO_PRIMARY_SPELL_POWER,
       EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE}}},
    {{{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_STEALTH_SHIELD, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_MAGE_RING, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_FOREMOST_SCROLL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, SPELL_FIREBLAST, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SPELL, SPELL_MASS_HASTE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, SPELL_SUMMON_EARTH_ELEMENTAL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, SPELL_CHAIN_LIGHTNING, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_WOOD_FIVE},
      {CAMPAIGN_CHOICE_RESOURCE, RES_ORE, EXPANSION_CAMPAIGN_ORE_FIVE},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND}},
     {{CAMPAIGN_CHOICE_INVALID,
       EXPANSION_CAMPAIGN_CHOICE_UNUSED_VALUE,
       EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT}},
     {{CAMPAIGN_CHOICE_INVALID,
       EXPANSION_CAMPAIGN_CHOICE_UNUSED_VALUE,
       EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
     ...
     {{CAMPAIGN_CHOICE_INVALID,
      ...
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, RES_WOOD, EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT}}},
    {{{CAMPAIGN_CHOICE_ARTIFACT, ARTIFACT_NOMAD_BOOTS, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_FIVE_HUNDRED},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_SCOUTING, HERO_SKILL_LEVEL_BASIC}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_PATHFINDING, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_NAVIGATION, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_RESOURCE, RES_SULFUR, EXPANSION_CAMPAIGN_SULFUR_FIFTEEN}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_ARCHERY, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_THREE_THOUSAND},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, HERO_PRIMARY_ATTACK, EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_NECROMANCY, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_LOGISTICS, HERO_SKILL_LEVEL_BASIC},
      {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}},
     {{CAMPAIGN_CHOICE_INVALID,
       EXPANSION_CAMPAIGN_CHOICE_UNUSED_VALUE,
...
void ExpCampaign::HandleVictory1(void) {
    switch (m_currentMap + 1) {
        case EXPANSION_MAP_NONE + 1:
            ...
            m_mapChoices[IDX(EXPANSION_MAP_POL_UPRISING)] = 1;
            break;
        case EXPANSION_MAP_POL_UPRISING + 1:
            PlaySmacker(EXPANSION_SMACKER_POL_UPRISING);
            m_mapChoices[IDX(EXPANSION_MAP_POL_ISLAND_OF_CHAOS)] = 1;
            break;
        case EXPANSION_MAP_POL_ISLAND_OF_CHAOS + 1:
            PlaySmacker(EXPANSION_SMACKER_POL_ISLAND_OF_CHAOS);
            m_mapChoices[IDX(EXPANSION_MAP_POL_ARROWS_FLIGHT)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_POL_ABYSS)] = 1;
            m_awards[IDX(EXPANSION_AWARD_BREASTPLATE_ANDURAN)] = 1;
            break;
        case EXPANSION_MAP_POL_ARROWS_FLIGHT + 1:
            PlaySmacker(EXPANSION_SMACKER_POL_ARROWS_FLIGHT);
            m_mapChoices[IDX(EXPANSION_MAP_POL_GIANTS_PASS)] = 1;
            m_awards[IDX(EXPANSION_AWARD_ELVEN_ALLIANCE)] = 1;
            m_awards[IDX(EXPANSION_AWARD_WOOD_BONUS)] = 1;
            break;
        case EXPANSION_MAP_POL_ABYSS + 1:
            PlaySmacker(EXPANSION_SMACKER_POL_BRANCH_REUNITED);
            m_mapChoices[IDX(EXPANSION_MAP_POL_AURORA_BOREALIS)] = 1;
            break;
        ...
        case EXPANSION_MAP_POL_AURORA_BOREALIS + 1:
            ...
            m_mapChoices[IDX(EXPANSION_MAP_POL_BETRAYALS_END)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_POL_CORRUPTIONS_HEART)] = 1;
            m_awards[IDX(EXPANSION_AWARD_HELMET_ANDURAN)] = 1;
            break;
        case EXPANSION_MAP_POL_BETRAYALS_END + 1:
            PlaySmacker(EXPANSION_SMACKER_POL_BETRAYALS_END);
            m_mapChoices[IDX(EXPANSION_MAP_POL_CORRUPTIONS_HEART)] = 1;
            m_awards[IDX(EXPANSION_AWARD_BATTLE_GARB)] = 1;
            m_awards[IDX(EXPANSION_AWARD_BREASTPLATE_ANDURAN)] = 0;
            m_awards[IDX(EXPANSION_AWARD_HELMET_ANDURAN)] = 0;
            m_awards[IDX(EXPANSION_AWARD_DEFEAT_KRAEGER)] = 1;
            break;
...
void ExpCampaign::HandleVictory2(void) {
    switch (m_currentMap + 1) {
        case EXPANSION_MAP_NONE + 1:
            ...
            m_mapChoices[IDX(EXPANSION_MAP_DES_CONQUER_AND_UNIFY)] = 1;
            break;
        case EXPANSION_MAP_DES_CONQUER_AND_UNIFY + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_CONQUER_AND_UNIFY);
            m_mapChoices[IDX(EXPANSION_MAP_DES_BORDER_TOWNS)] = 1;
            break;
        case EXPANSION_MAP_DES_BORDER_TOWNS + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_BORDER_TOWNS);
            m_mapChoices[IDX(EXPANSION_MAP_DES_WAYWARD_SON)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_DES_UNCLE_IVAN)] = 1;
            break;
        case EXPANSION_MAP_DES_WAYWARD_SON + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_FAMILY_REUNITED);
            m_mapChoices[IDX(EXPANSION_MAP_DES_SOUTHERN_WAR)] = 1;
            m_awards[IDX(EXPANSION_AWARD_WAYWARD_SON)] = 1;
            break;
        case EXPANSION_MAP_DES_UNCLE_IVAN + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_FAMILY_REUNITED);
            m_mapChoices[IDX(EXPANSION_MAP_DES_SOUTHERN_WAR)] = 1;
            m_awards[IDX(EXPANSION_AWARD_UNCLE_IVAN)] = 1;
            break;
        case EXPANSION_MAP_DES_SOUTHERN_WAR + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_SOUTHERN_WAR);
            m_mapChoices[IDX(EXPANSION_MAP_DES_IVORY_GATES)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_DES_ELVEN_LANDS)] = 1;
            break;
        case EXPANSION_MAP_DES_IVORY_GATES + 1:
            PlaySmacker(EXPANSION_SMACKER_DES_BRANCH_REUNITED);
            m_mapChoices[IDX(EXPANSION_MAP_DES_EPIC_BATTLE)] = 1;
            m_awards[IDX(EXPANSION_AWARD_LEGENDARY_SCEPTER)] = 1;
            break;
...
void ExpCampaign::HandleVictory3(void) {
    switch (m_currentMap + 1) {
        case EXPANSION_MAP_NONE + 1:
            ...
            m_mapChoices[IDX(EXPANSION_MAP_WIZ_SHROUDED_ISLES)] = 1;
            break;
        case EXPANSION_MAP_WIZ_SHROUDED_ISLES + 1:
            PlaySmacker(EXPANSION_SMACKER_WIZ_SHROUDED_ISLES);
            m_mapChoices[IDX(EXPANSION_MAP_WIZ_ETERNAL_SCROLLS)] = 1;
            break;
        case EXPANSION_MAP_WIZ_ETERNAL_SCROLLS + 1:
            PlaySmacker(EXPANSION_SMACKER_WIZ_ETERNAL_SCROLLS);
            m_mapChoices[IDX(EXPANSION_MAP_WIZ_POWERS_END)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_WIZ_FOUNT_OF_WIZARDRY)] = 1;
            m_awards[IDX(EXPANSION_AWARD_SET_GUARDIAN)] = 1;
            break;
        case EXPANSION_MAP_WIZ_POWERS_END + 1:
            PlaySmacker(EXPANSION_SMACKER_WIZ_POWERS_END);
            m_mapChoices[IDX(EXPANSION_MAP_WIZ_FOUNT_OF_WIZARDRY)] = 1;
            m_awards[IDX(EXPANSION_AWARD_SPHERE_NEGATION)] = 1;
            break;
...
void ExpCampaign::HandleVictory4(void) {
    switch (m_currentMap + 1) {
        case EXPANSION_MAP_NONE + 1:
            ...
            m_mapChoices[IDX(EXPANSION_MAP_VOY_STRANDED)] = 1;
            break;
        case EXPANSION_MAP_VOY_STRANDED + 1:
            PlaySmacker(EXPANSION_SMACKER_VOY_STRANDED);
            m_mapChoices[IDX(EXPANSION_MAP_VOY_PIRATE_ISLES)] = 1;
            break;
        case EXPANSION_MAP_VOY_PIRATE_ISLES + 1:
            PlaySmacker(EXPANSION_SMACKER_VOY_PIRATE_ISLES);
            m_mapChoices[IDX(EXPANSION_MAP_VOY_KING_AND_COUNTRY)] = 1;
            m_mapChoices[IDX(EXPANSION_MAP_VOY_BLOOD_IS_THICKER)] = 1;
            break;
...
void ExpCampaign::ReplaySmacker1(void) {
    switch (m_viewMap + 1) {
        ...
        case EXPANSION_MAP_POL_BETRAYALS_END + 1:
            ...
            break;
        case EXPANSION_MAP_POL_CORRUPTIONS_HEART + 1:
            if (m_mapsPlayed[IDX(EXPANSION_MAP_POL_BETRAYALS_END)])
                PlaySmacker(EXPANSION_SMACKER_POL_BETRAYALS_END);
            else
                PlaySmacker(EXPANSION_SMACKER_POL_AURORA_BOREALIS);
            break;
...
void ExpCampaign::ReplaySmacker3(void) {
    switch (m_viewMap + 1) {
        ...
        case EXPANSION_MAP_WIZ_POWERS_END + 1:
            ...
            break;
        case EXPANSION_MAP_WIZ_FOUNT_OF_WIZARDRY + 1:
            if (m_mapsPlayed[IDX(EXPANSION_MAP_WIZ_POWERS_END)])
                PlaySmacker(EXPANSION_SMACKER_WIZ_POWERS_END);
            else
                PlaySmacker(EXPANSION_SMACKER_WIZ_ETERNAL_SCROLLS);
            break;
