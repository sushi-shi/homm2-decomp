...
DATA(0x0051d560) SCampaignChoice xCampaignChoices[IDX(
    ...
    {{{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MEDAL_OF_VALOR), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_STEALTH_SHIELD), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MINOR_SCROLL), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_WHITE_PEARL), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_BALLISTA), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}},
     {{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MAGE_RING), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MAJOR_SCROLL), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_LOGISTICS), IDX(HERO_SKILL_LEVEL_ADVANCED)}},
     {{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MEDAL_OF_HONOR), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_CASTER_BRACELET), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_DEFENDER_HELM), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_POWER_AXE), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, IDX(HERO_PRIMARY_DEFENSE), EXPANSION_CAMPAIGN_PRIMARY_BONUS_TWO}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      {CAMPAIGN_CHOICE_CREATURES, IDX(CREATURE_CRUSADER), EXPANSION_CAMPAIGN_CRUSADER_COUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_TRAVELER_BOOTS), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_SULFUR), EXPANSION_CAMPAIGN_SULFUR_TEN},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_POWER_AXE), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL_SCROLL, IDX(SPELL_ANIMATE_DEAD), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SPELL, IDX(SPELL_VIEW_HEROES), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_CREATURES, IDX(CREATURE_MAGE), EXPANSION_CAMPAIGN_MAGE_COUNT},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_ESTATES), IDX(HERO_SKILL_LEVEL_ADVANCED)}}},
    {{{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_WOOD_FIFTY},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_CRYSTAL), EXPANSION_CAMPAIGN_CRYSTAL_TEN}},
     {{CAMPAIGN_CHOICE_PRIMARY_SKILL, IDX(HERO_PRIMARY_ATTACK), EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, IDX(HERO_PRIMARY_DEFENSE), EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_LOGISTICS), IDX(HERO_SKILL_LEVEL_BASIC)},
      {CAMPAIGN_CHOICE_SPELL, IDX(SPELL_STEEL_SKIN), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MAGE_RING), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_LOGISTICS), IDX(HERO_SKILL_LEVEL_BASIC)},
     ...
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_LUCK), IDX(HERO_SKILL_LEVEL_BASIC)},
      ...
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_SPIKED_SHIELD), EXPANSION_CAMPAIGN_ARTIFACT_AMOUNT_ONE}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_PENALTY_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_WOOD_PENALTY_TEN},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_MERCURY), EXPANSION_CAMPAIGN_MERCURY_PENALTY_TWO}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_SCOUTING), IDX(HERO_SKILL_LEVEL_BASIC)},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_WOOD_TWENTY}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_LEADERSHIP), IDX(HERO_SKILL_LEVEL_BASIC)},
    ...
    {{{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND},
      ...
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_STEALTH_SHIELD), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_MAGE_RING), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_FOREMOST_SCROLL), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, IDX(SPELL_FIREBLAST), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_SPELL, IDX(SPELL_MASS_HASTE), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, IDX(SPELL_SUMMON_EARTH_ELEMENTAL), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_SPELL, IDX(SPELL_CHAIN_LIGHTNING), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
     {{CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_WOOD_FIVE},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_ORE), EXPANSION_CAMPAIGN_ORE_FIVE},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_ONE_THOUSAND}},
     {{CAMPAIGN_CHOICE_INVALID,
       EXPANSION_CAMPAIGN_CHOICE_UNUSED_VALUE,
       EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT}},
     {{CAMPAIGN_CHOICE_INVALID,
       EXPANSION_CAMPAIGN_CHOICE_UNUSED_VALUE,
       EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
     ...
     {{CAMPAIGN_CHOICE_INVALID,
      ...
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_WOOD), EXPANSION_CAMPAIGN_CHOICE_ZERO_AMOUNT}}},
    {{{CAMPAIGN_CHOICE_ARTIFACT, IDX(ARTIFACT_NOMAD_BOOTS), EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_FIVE_HUNDRED},
      {CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_SCOUTING), IDX(HERO_SKILL_LEVEL_BASIC)}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_PATHFINDING), IDX(HERO_SKILL_LEVEL_BASIC)},
      ...
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_SULFUR), EXPANSION_CAMPAIGN_SULFUR_FIFTEEN}},
     {{CAMPAIGN_CHOICE_SECONDARY_SKILL, IDX(HERO_SKILL_ARCHERY), IDX(HERO_SKILL_LEVEL_BASIC)},
      {CAMPAIGN_CHOICE_RESOURCE, IDX(RES_GOLD), EXPANSION_CAMPAIGN_GOLD_THREE_THOUSAND},
      {CAMPAIGN_CHOICE_PRIMARY_SKILL, IDX(HERO_PRIMARY_ATTACK), EXPANSION_CAMPAIGN_PRIMARY_BONUS_ONE}},
