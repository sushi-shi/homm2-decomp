...
xCampaignChoices[EXPANSION_CAMPAIGN_COUNT]
                ...
                [EXPANSION_CAMPAIGN_BONUS_CHOICE_COUNT] = {
    {
        ...
        {{CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_WHITE_PEARL, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_BALLISTA, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}},
        ...
        {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_PRIMARY_SKILL, HERO_PRIMARY_DEFENSE, EXPANSION_CAMPAIGN_PRIMARY_BONUS_TWO}},
        {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}, {CAMPAIGN_CHOICE_CREATURES, CREATURE_CRUSADER, EXPANSION_CAMPAIGN_CRUSADER_COUNT}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_TRAVELER_BOOTS, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
        {{CAMPAIGN_CHOICE_RESOURCE, RES_SULFUR, EXPANSION_CAMPAIGN_SULFUR_TEN}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_SPELL_SCROLL, SPELL_ANIMATE_DEAD, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
        {{CAMPAIGN_CHOICE_SPELL, EXPANSION_CAMPAIGN_SPELL_VIEW_HEROES, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_CREATURES, CREATURE_MAGE, EXPANSION_CAMPAIGN_MAGE_COUNT}, {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_ESTATES, HERO_SKILL_LEVEL_ADVANCED}}
    },
    {
    ...
    {
        {{CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_TWO_THOUSAND}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_POWER_AXE, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_STEALTH_SHIELD, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}},
    ...
    {
        {{CAMPAIGN_CHOICE_ARTIFACT, EVENT_ARTIFACT_NOMAD_BOOTS, EXPANSION_CAMPAIGN_CHOICE_NO_AMOUNT}, {CAMPAIGN_CHOICE_RESOURCE, RES_GOLD, EXPANSION_CAMPAIGN_GOLD_FIVE_HUNDRED}, {CAMPAIGN_CHOICE_SECONDARY_SKILL, HERO_SKILL_SCOUTING, HERO_SKILL_LEVEL_BASIC}},
