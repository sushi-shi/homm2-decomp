...
DATA(0x0051d450) static i32
    expansionCampaignTrackXY[EXPANSION_CAMPAIGN_COUNT][EXPANSION_CAMPAIGN_MAX_MAP_COUNT][2] = {
        {{113, 310},
         {187, 310},
         {261, 352},
         {261, 310},
...
DATA(0x0051d550) static i32 expansionCampaignMapCounts[EXPANSION_CAMPAIGN_COUNT] = {8, 8, 4, 4};

DATA(0x0051d560) SCampaignChoice xCampaignChoices
    [EXPANSION_CAMPAIGN_COUNT][EXPANSION_CAMPAIGN_MAX_MAP_COUNT]
...
DATA(0x0051d740) static i8 expansionCampaignDifficulty[EXPANSION_CAMPAIGN_COUNT]
        ...
        if (m_awards[award] != 0) {
            switch (award) {
                ...
                case EXPANSION_AWARD_SET_GUARDIAN:
                    if (player->m_heroCount > 0)
                        gpGame->GetHero(player->m_heroIds[0])->m_spells[SPELL_SET_EARTH_GUARDIAN] =
                            1;
                    break;
