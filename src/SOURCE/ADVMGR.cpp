    ...
    if (message.type == MESSAGE_WIDGET) {
        if ((H2EnumIndex((message.payload.widget.modifiers) & (MESSAGE_MODIFIER_RIGHT_BUTTON)))) {
            if (message.payload.widget.command == WIDGET_NOTIFY_SELECT
                ...
                switch (message.payload.widget.id) {
                    case H2EnumIndex(SYSTEM_OPTIONS_DIALOG_ACCEPT):
                        helpIndex = SYSTEM_OPTIONS_HELP_ACCEPT;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_MUSIC_VOLUME):
                        helpIndex = SYSTEM_OPTIONS_HELP_MUSIC_VOLUME;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_SOUND_VOLUME):
                        helpIndex = SYSTEM_OPTIONS_HELP_SOUND_VOLUME;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_HERO_SPEED):
                        helpIndex = SYSTEM_OPTIONS_HELP_HERO_SPEED;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_MUSIC_SOURCE):
                        helpIndex = SYSTEM_OPTIONS_HELP_MUSIC_SOURCE;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_SHOW_ROUTE):
                        helpIndex = SYSTEM_OPTIONS_HELP_SHOW_ROUTE;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_COMPUTER_SPEED):
                        helpIndex = SYSTEM_OPTIONS_HELP_COMPUTER_SPEED;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_INTERFACE):
                        helpIndex = SYSTEM_OPTIONS_HELP_INTERFACE;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_VIDEO):
                        helpIndex = SYSTEM_OPTIONS_HELP_VIDEO;
                        break;
                    case H2EnumIndex(SYSTEM_OPTION_COLOR_CURSOR):
                ...
                case WIDGET_NOTIFY_SELECT: {
                    switch (
                        ...
                        case H2EnumIndex(SYSTEM_OPTION_COLOR_CURSOR):
                            ...
                            break;
                        case H2EnumIndex(SYSTEM_OPTION_COUNT):
                            break;
                    }
                    break;
                }
