...
i32 combatManager::EffectSpellCreateCreature(i32 hex, SpellType spell) {
    ...
    i32 creatureEffect = H2EnumIndex(creatureType) * gMonsterDatabase[H2EnumIndex(creatureType)].fightValue;
...
void combatManager::EffectSpellResurrect(i32* effect, i32 hex, SpellType spell) {
    ...
    *effect = quantityResult[0] * gMonsterDatabase[H2EnumIndex(targetStack->m_monsterType)].fightValue;
