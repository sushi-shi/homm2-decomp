...
typedef i32 CombatSpellAITargetMode;
...
i32 combatManager::DoSpellAI(CombatSide side, i32 restricted) {
    ...
    for (spell = SPELL_FIREBALL; spell < SPELL_COUNT; spell++) {
        if (m_heroes[(side)]->HasSpell(spell)
            && (((gsSpellInfo[(spell)].attributes) & (SPELL_INFO_ATTRIBUTE_COMBAT)))
    ...
    *bestEffect = 0;
    ...
    switch (spell) {
        ...
        case SPELL_MASS_SHIELD:
            ...
            team_9 = (m_currentSide);
            break;
        case SPELL_MASS_SLOW:
        case SPELL_MASS_CURSE:
            spellMode = SPELL_AI_SUM_ENEMY;
            team_9 = (OppositeCombatSide(m_currentSide));
            break;
        case SPELL_DISPEL:
    ...
    while (!bDone) {
        ...
        if (m_hexCells[hexCell_9].m_occupantIndex >= 0
            ...
            targetCreature = &m_armies[(m_hexCells[hexCell_9].m_occupantSide)]
                                      [m_hexCells[hexCell_9].m_occupantIndex];
            giCurrSpellGroup = (m_hexCells[hexCell_9].m_occupantSide);
            fullQuantityFlag_4 =
        ...
        switch (spell) {
            case SPELL_CURE:
                EffectSpellCure(&effect_8, (m_currentSide), hexCell_9, 1);
                break;
            case SPELL_MASS_CURE:
                EffectSpellCure(&effect_8, (m_currentSide), -1, 1);
                break;
            case SPELL_DISPEL:
                EffectSpellCure(&effect_8, (targetCreature->m_side), targetCreature->m_index, 0);
                break;
            case SPELL_MASS_DISPEL:
                    ...
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_SLOW)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_SLOW)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_SLOW)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
                ...
                if (targetCreature
                    ...
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_HYPNOTIZE)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_HYPNOTIZE)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_HYPNOTIZE)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
                ...
                if (targetCreature
                    ...
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_BERSERK)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_BERSERK)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_BERSERK)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
                ...
                if (targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_HASTE)]) {
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_HASTE)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_HASTE)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_HASTE)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
                ...
                if (targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_CURSE)]) {
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_CURSE)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_CURSE)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_CURSE)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
                ...
                if (targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_BLESS)]) {
                    effect_8 = static_cast<i32>(
                        ...
                        - RawEffectSpellInfluence(targetCreature, ARMY_SPELL_INFLUENCE_BLESS)
                              * gfCancelDurationMods
                                  [targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_BLESS)] + fullQuantityFlag_4
                                         < SPELL_AI_MAX_DURATION
                                     ? targetCreature->m_spellInfluence[(ARMY_SPELL_INFLUENCE_BLESS)] + fullQuantityFlag_4
                                     : SPELL_AI_MAX_DURATION]
                    );
            ...
            case SPELL_EARTHQUAKE:
                if (m_currentSide == COMBAT_ATTACKER_SIDE && m_inCastleCombat != 0) {
                    ...
                    for (idx_3 = 0; idx_3 < COMBAT_WALL_SECTION_COUNT; idx_3++) {
                        if (m_wallStates[idx_3 + (COMBAT_WALL_SLOT_SECTION_FIRST)]
                                == COMBAT_WALL_STATE_DESTROYED
                            || m_wallStates[idx_3 + (COMBAT_WALL_SLOT_SECTION_FIRST)]
...
i32 combatManager::EffectSpellCreateCreature(i32 hex, SpellType spell) {
    ...
    i32 spellPower [[maybe_unused]] = m_spellPower[(m_currentSide)];
    ...
    switch (spell) {
        ...
        default:
            ...
            monType = m_armies[(m_hexCells[hex].m_occupantSide)][m_hexCells[hex].m_occupantIndex]
                               .m_monsterType;
            spellPower =
    ...
    i32 creatureEffect = (monType) * gMonsterDatabase[(monType)].fightValue;
    if (spell == SPELL_MIRROR_IMAGE) {
        ...
        if ((((gMonsterDatabase[(monType)].flags.abilityFlags) & (MONSTER_ABILITY_FLAG_SHOOTER))))
            creatureEffect =
...
i32 combatManager::RawEffectSpellInfluence(army* target, ArmySpellInfluence influence) {
    ...
    army* other = NULL;
    float castChance =
        target->SpellCastWorkChance(SpellType(giSpellInfluenceToSpell[(influence)]));
    ...
    switch (influence) {
        ...
        case ARMY_SPELL_INFLUENCE_DRAGON_SLAYER:
            ...
            for (cnt = 0; cnt < m_armyCount[(OppositeCombatSide(target->m_side))]; cnt++) {
                other = &m_armies[(target->m_side)][cnt];
            ...
            if (adjacent)
                ...
                factor = static_cast<float>(
                    dragonCounter / m_armyCount[(OppositeCombatSide(target->m_side))]
                );
        ...
        case ARMY_SPELL_INFLUENCE_SHIELD:
            ...
            for (cnt = 0; cnt < m_armyCount[(OppositeCombatSide(target->m_side))]; cnt++) {
                other = &m_armies[(target->m_side)][cnt];
                if ((((other->m_monster.flags.all) & (MONSTER_FLAGS_SHOOTER))))
                    shooters++;
            }
            factor = static_cast<float>(
                shooters / m_armyCount[(OppositeCombatSide(target->m_side))]
            );
    ...
    while (!done_11) {
        ...
        for (index_1 = 0; index_1 < COMBAT_ARMY_SLOT_COUNT; index_1++) {
            ...
            if (m_armies[sideWork_6][index_1].IsAlive()) {
                ...
                fullQuantityWork =
                    (((combatTarget->m_monster.flags.all) & (MONSTER_FLAGS_FULL_AI_QUANTITY))) != 0;
                ...
                for (influence_9 = ARMY_SPELL_INFLUENCE_HASTE;
                     ...
                     influence_9++) {
                    if (combatTarget->m_spellInfluence[(influence_9)]) {
                        switch (influence_9) {
                            case ARMY_SPELL_INFLUENCE_HASTE:
                            case ARMY_SPELL_INFLUENCE_BLESS:
                            case ARMY_SPELL_INFLUENCE_DRAGON_SLAYER:
                            ...
                            case ARMY_SPELL_INFLUENCE_STEELSKIN:
                                positiveEffectResult_19 = static_cast<i32>(
                                    ...
                                    + RawEffectSpellInfluence(
                                          ...
                                          * gfCancelDurationMods
                                              [combatTarget->m_spellInfluence[(influence_9)]
                                                           + fullQuantityWork
                                                       < SPELL_AI_MAX_DURATION
                                                   ? combatTarget->m_spellInfluence[(influence_9)]
                                                         + fullQuantityWork
        ...
        if (cure == 1)
            positiveEffectResult_19 = 0;
    if (sideWork_6 == (m_currentSide))
            *effect += -negativeEffectResult - positiveEffectResult_19;
        else
            *effect += positiveEffectResult_19 + negativeEffectResult;
        if (targetSide == SPELL_AI_ANY_SIDE && sideWork_6 == (m_currentSide))
            sideWork_6 = (OppositeCombatSide(m_currentSide));
        else
            done_11 = true;
    }
}
...
void combatManager::EffectSpellResurrect(i32* effect, i32 hex, SpellType spell) {
    ...
    resurrectPower = m_spellPower[(m_currentSide)] * COMBAT_SPELL_AI_RESURRECT_POINTS_PER_POWER;
    ...
    *effect = count * gMonsterDatabase[(target->m_monsterType)].fightValue;
...
void combatManager::EffectSpellDamage(i32* effect, SpellType spell, i32 targetHex) {
    ...
    damage = m_spellPower[(m_currentSide)] * damagePerPowerResult_9;
    currentHex_1 = 0;
    step_3 = 0;
    doneWork = false;
    ...
    for (side_6 = COMBAT_ATTACKER_SIDE; (side_6) < COMBAT_SIDE_COUNT; side_6++) {
        stacksKilledCandidate_1[(side_6)] = 0;
        fightValueKilledAI_3[(side_6)] = 0;
        killedCombatValue_1[(side_6)] = 0;
    }
    ClearEffects();
    ...
    while (!doneWork) {
            ...
            case SPELL_CHAIN_LIGHTNING:
                if (currentHex_1 == 0) {
                    ...
                    currentHex_1 = GetNextChainLightningTarget(
                        &m_armies[(m_hexCells[currentHex_1].m_occupantSide)]
        ...
        if (!doneWork) {
            ...
            targetCreature_18 = &m_armies[(m_hexCells[currentHex_1].m_occupantSide)]
                                      [m_hexCells[currentHex_1].m_occupantIndex];
            if (!gArmyEffected[(m_hexCells[currentHex_1].m_occupantSide)]
                              [m_hexCells[currentHex_1].m_occupantIndex]) {
                gArmyEffected[(m_hexCells[currentHex_1].m_occupantSide)]
                ...
                if (workChanceWork > 0.0f) {
                    ...
                    ModifyDamageForArtifacts(
                        ...
                        m_heroes[(targetCreature_18->m_side)]
                    );
                    if ((((targetCreature_18->m_monster.flags.all) & (MONSTER_FLAGS_MIRROR_IMAGE)))
                        && spellDamageWork != 0)
                    ...
                    if (creaturesKilledResult_5 >= targetCreature_18->m_quantity) {
                        ...
                        remainderResult_4 = 0;
                        stacksKilledCandidate_1[(m_hexCells[currentHex_1].m_occupantSide)]++;
                    }

                    fightValueKilledAI_3[(m_hexCells[currentHex_1].m_occupantSide)] +=
                        (creaturesKilledResult_5 * targetCreature_18->m_monster.hitPoints
                         + remainderResult_4 * COMBAT_SPELL_AI_PARTIAL_DAMAGE_MODIFIER)
                        * gMonsterDatabase[(targetCreature_18->m_monsterType)].fightValue
                        / targetCreature_18->m_monster.hitPoints;
                    killedCombatValue_1[(m_hexCells[currentHex_1].m_occupantSide)] +=
                        creaturesKilledResult_5 * targetCreature_18->m_monster.hitPoints
                        * gMonsterDatabase[(targetCreature_18->m_monsterType)].fightValue
                        / targetCreature_18->m_monster.hitPoints;
                    if ((((targetCreature_18->m_monster.flags.all) & (MONSTER_FLAGS_MIRROR_IMAGE)))) {
    ...
    if (stacksKilledCandidate_1[0] >= m_armyCount[0] || stacksKilledCandidate_1[1] >= m_armyCount[1]) {
        if (killedCombatValue_1[(m_currentSide)] <= 0) {
            *effect = COMBAT_SPELL_AI_DECISIVE_EFFECT - gsSpellInfo[(spell)].aiValue
                      + disruptingRayValueTotal_11;
        } else {
            *effect = killedCombatValue_1[(OppositeCombatSide(m_currentSide))] - killedCombatValue_1[(m_currentSide)]
                      + disruptingRayValueTotal_11;
        }
    } else {
        *effect = fightValueKilledAI_3[(OppositeCombatSide(m_currentSide))] - fightValueKilledAI_3[(m_currentSide)]
                  + disruptingRayValueTotal_11;
    }
