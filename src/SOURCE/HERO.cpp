...
RVA(0x0046c4cd, 0x59)
int hero::HasArtifact(int);

RVA(0x0046c526, 0x277)
int hero::CalcMobility(void);

RVA(0x0046c79d, 0xcf)
int hero::HasSpell(int);

RVA(0x0046c86c, 0xc5)
int hero::GetNthSpell(int, int);

RVA(0x0046c931, 0xd0)
int hero::GetNumSpells(int);
...
RVA(0x0047024b, 0xfa)
int hero::TakeSS(int, int);

RVA(0x00470345, 0xbf)
int hero::GiveSS(int, int);

RVA(0x00470404, 0x6a)
int hero::CreatureTypeCount(int);

RVA(0x0047046e, 0x5e)
void hero::UpgradeCreatures(int, int);

RVA(0x004704cc, 0x5e)
int hero::GetNthSS(int);

RVA(0x0047052a, 0x51)
class town * hero::GetOccupiedTown(void);

RVA(0x0047057b, 0x47)
signed char hero::Stats(int);

RVA(0x004705c2, 0xc3)
signed char hero::GetSSLevel(int);

RVA(0x00470685, 0xf4)
void hero::DoSSLevelDialog(int, int);

RVA(0x00470779, 0x12f)
