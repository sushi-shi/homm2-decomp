...
#define AI_QUICK_COMBAT_DEFEAT_THRESHOLD                                                           \
    DATA_COMPGEN(0x004ea778, aiQuickCombatDefeatThreshold, 0.99)
...
i32 philAI::ChooseToFightForArtifact(
    ArtifactType artifact, H2_ENUM_PARAM(CreatureType, i32) monster, i32 quantity
) {
    i32 remainB;
    i32 remainA;
    i32 lostB;
