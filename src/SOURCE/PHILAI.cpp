...
i32 philAI::RVConversion(i32* const resources) {
    return (i32)((((((((float)resources[H2EnumIndex(RES_GOLD)] * gafAITurnCostResource[H2EnumIndex(RES_GOLD)])
                      + (float)resources[H2EnumIndex(RES_WOOD)] * gafAITurnCostResource[H2EnumIndex(RES_WOOD)])
                     + (float)resources[H2EnumIndex(RES_ORE)] * gafAITurnCostResource[H2EnumIndex(RES_ORE)])
                    + (float)resources[H2EnumIndex(RES_CRYSTAL)] * gafAITurnCostResource[H2EnumIndex(RES_CRYSTAL)])
                   + (float)resources[H2EnumIndex(RES_SULFUR)] * gafAITurnCostResource[H2EnumIndex(RES_SULFUR)])
                  + (float)resources[H2EnumIndex(RES_MERCURY)] * gafAITurnCostResource[H2EnumIndex(RES_MERCURY)])
                 + (float)resources[H2EnumIndex(RES_GEMS)] * gafAITurnCostResource[H2EnumIndex(RES_GEMS)]);
}
