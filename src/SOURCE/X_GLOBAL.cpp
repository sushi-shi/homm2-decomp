...
DATA(0x004f2aa0) unsigned char xNewHeroAlignment[X_GLOBAL_NEW_HERO_ALIGNMENT_COUNT] = {
    HERO_CLASS_KNIGHT, HERO_CLASS_KNIGHT, HERO_CLASS_NECROMANCER, HERO_CLASS_BARBARIAN,
    HERO_CLASS_WIZARD, HERO_CLASS_SORCERESS, HERO_CLASS_KNIGHT, HERO_CLASS_KNIGHT,
    HERO_CLASS_NECROMANCER, HERO_CLASS_BARBARIAN, HERO_CLASS_WARLOCK, HERO_CLASS_KNIGHT,
    HERO_CLASS_KNIGHT, HERO_CLASS_KNIGHT, HERO_CLASS_KNIGHT, HERO_CLASS_KNIGHT
};
DATA(0x004f2ab0) int xShrineBuildingCost[X_GLOBAL_BUILDING_RESOURCE_COUNT] = {
    10, 0, 0, 0, 10, 0, 4000
};
DATA(0x00527e78) int xPasswordStringsIndex[X_GLOBAL_PASSWORD_STRING_INDEX_COUNT];
