...
DATA(0x004f2aa0) u8 xNewHeroAlignment[X_GLOBAL_NEW_HERO_ALIGNMENT_COUNT] = {
    FACTION_KNIGHT, FACTION_KNIGHT, FACTION_NECROMANCER, FACTION_BARBARIAN,
    FACTION_WIZARD, FACTION_SORCERESS, FACTION_KNIGHT, FACTION_KNIGHT,
    FACTION_NECROMANCER, FACTION_BARBARIAN, FACTION_WARLOCK, FACTION_KNIGHT,
    FACTION_KNIGHT, FACTION_KNIGHT, FACTION_KNIGHT, FACTION_KNIGHT
};
