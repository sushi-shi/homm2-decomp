...
#define COMBAT_AI_MEDIUM_ARTIFACT_RETREAT_BONUS                                   \
    DATA_COMPGEN(0x004ea498, combatAiMediumArtifactRetreatBonus, 0.05)
#define COMBAT_AI_LOW_ARTIFACT_RETREAT_BONUS                                      \
    DATA_COMPGEN(0x004ea490, combatAiLowArtifactRetreatBonus, 0.04)
#define COMBAT_AI_STRENGTH_30000_RETREAT_PENALTY                                  \
    DATA_COMPGEN(0x004ea488, combatAiStrength30000RetreatPenalty, 0.08)
...
#define COMBAT_AI_STRENGTH_2500_RETREAT_PENALTY                                   \
    DATA_COMPGEN(0x004ea480, combatAiStrength2500RetreatPenalty, 0.02)
