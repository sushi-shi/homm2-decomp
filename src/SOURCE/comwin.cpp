...
VA(0x0048ab13, 0x34a)
short int com_init(unsigned char, int, int) { return 0; }

VA(0x0048ae5d, 0x11d)
void com_term(short int) {}

VA(0x0048af7a, 0xdd)
short int com_rcv(short int, unsigned short int, void *) { return 0; }

VA(0x0048b057, 0x145)
short int com_snd(short int, unsigned short int, unsigned short int, void *, int) { return 0; }

VA(0x0048b19c, 0x13)
short int __cdecl com_sess(int, int, ...) { return 0; }

VA(0x0048b1af, 0x6e)
unsigned char com_stat(short int, unsigned short int) { return 0; }
