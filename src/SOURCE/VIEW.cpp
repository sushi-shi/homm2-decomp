...
typedef enum ViewGeneralAction {
    ...
    GENERAL_ACTION_CAST_SPELL = (COMBAT_MESSAGE_COMMAND_CAST_SPELL),
    GENERAL_ACTION_RETREAT    = (COMBAT_MESSAGE_COMMAND_RETREAT),
    GENERAL_ACTION_SURRENDER  = (COMBAT_MESSAGE_COMMAND_SURRENDER)
} ViewGeneralAction;
