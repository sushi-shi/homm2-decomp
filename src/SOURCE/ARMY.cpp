...
void army::SpecialAttack(void)
{
    ...
    if (m_spellInfluence[5] || m_spellInfluence[7]) {
        CancelSpellType(1);
        gpCombatManager->DrawFrame(1, 0, 0, 0, ARMY_COMBAT_FRAME_DELAY, 1, 1);
    }
}
...
VA(0x0044f41e, 0x25)
int army::WalkTo(void) { return 0; }

VA(0x0044f443, 0x2ee)
int army::WalkTo(int) { return 0; }

VA(0x0044f731, 0x25)
int army::AttackTo(void) { return 0; }

VA(0x0044f756, 0x1e8)
int army::AttackTo(int) { return 0; }
