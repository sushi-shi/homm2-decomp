...
char **cArmyDetail;
char **cWellDetail;
char **cKingdomOverview;
char **cNewTurn;
char **cViewGeneralLabels;
char **cViewGeneralHelp;
char **cViewGeneralLongHelp;
char **cCombatMessage;
char **cHeroLevel;
char **cCombatHelp;
char **cLongCombatHelp;
char **cTownCommand;
char **gHeroDefaultNames;
char **gNewGameHelp;
char **gSetupBaudHelp;
char **gSetupComPortHelp;
char **gSetupDCBaudHelp;
char **gSetupDCComPortHelp;
char **gSetupHotSeatGameHelp;
char **gSetupModemGameHelp;
char **gSetupDCGameHelp;
char **gSetupMultiPlayerGameHelp;
char **gSetupNetworkGameHelp;
char **gSetupNetworkGame2Help;
char **gSetupGameHelp;
char **cBattleResults;
char **cMoraleInfo;
char **cMapSize;
char **cDifficulty;
char **cStartDifficulty;
char **cCampaignLeaders;
char **cWinText;
char **cHumanDifficulty;
char **cHumanInfoDifficulty;
char **musicQualityText;
char **gSpellDesc;
char **gSpellNames;
char **gSecondarySkillLevels;
char **gSecondarySkills;
...
char **cDirections;
char **cRumourTerrainDescriptions;
char **gInterfaceTypeText;
char **cBWMouseText;
char **combatSpeedText;
char **combatMiniInfoText;
char **gcCommandLineHelp;
char **cOverviewText;
char **cWinComError;
char **cMiniViewText;
char **gFileRequestHelp;
char **cPersonality;
char **cRandomTavernText;
char **cRandomSignText;
char **cCampaignAwards;
char *cOutOfMemory;
char **cSlowVideoLevelText;
char **gSPanelHelp;
char **xBarrierColor;
char **xGenericSiteNames;
char **xRecruitmentSiteNames;
...
unsigned char *bSaveMusicPosition;
