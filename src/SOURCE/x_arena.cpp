...
i32 DoArenaDialog(void) {
    ...
    strcpy(
        ...
        "Вы вошли на арену и сразились со сворой свирепых львов. "
            "Впечатленный вашим мастерством тренер гладиаторов "
            "согласился научить вас одному навыку на ваш выбор."
    );
